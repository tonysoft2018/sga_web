		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                        <input type="text" name="" id="txt_Entrada" placeholder="Busqueda por Folio" class="form-control" style='height: 30px;width:300px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="Buscar_Entrada(event)" >    
