<?php
// ----------------------------------------------------------------------------------
// ambiente_bannerapp.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_BannerApp_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_bannerapp";
     private $NombreDeLaVista = "tbl_ambiente_bannerapp";
     private $NombreCampoLlave ="nIDBannerApp";
	 private $NombreCampoOrdenamiento="nIDBannerApp";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_norepetir,"Imagen");  
