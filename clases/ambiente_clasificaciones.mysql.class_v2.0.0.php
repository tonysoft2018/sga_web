<?php
// ----------------------------------------------------------------------------------
// ambiente_clasificaciones.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_Clasificaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_clasificaciones";
     private $NombreDeLaVista = "tbl_ambiente_clasificaciones";
     private $NombreCampoLlave ="nIDAmbiente_Clasificacion";
	 private $NombreCampoOrdenamiento="Clasificacion";
	 private $NombreCampoParaNoRepetir="Clasificacion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Clasificacion");		
		...
		array_push($this->campos_norepetir,"Clasificacion");  		 
