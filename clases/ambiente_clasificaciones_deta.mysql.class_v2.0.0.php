...
class cltbl_Ambiente_Clasificaciones_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_clasificaciones_deta";
     private $NombreDeLaVista = "tbl_ambiente_clasificaciones_deta_view";
     private $NombreCampoLlave ="nIDAmbiente_Clasificacion_Deta";
	 private $NombreCampoOrdenamiento="nIDAmbiente_Clasificacion";
	 private $NombreCampoParaNoRepetir="nIDModulo";
	 ...
	 public function setInformacion_Grabar($registro) {
		...
		//echo "contcampos:" . $this->contCampos;
		for($i=0;$i<$this->contCampos;$i=$i+1){					 
			$this->dtGrabar[$this->contNumDatos][$this->estructura[$i]]=$registro[$i];			 
		}
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDAmbiente_Clasificacion");
		...
		array_push($this->campos_obligatorios_leyendas,"No tiene ID del Modulo"); 
		...
		array_push($this->campos_norepetir,"nIDModulo");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Crear");		
        array_push($this->campos_listado,"Editar");	 
        array_push($this->campos_listado,"Eliminar");	 
        array_push($this->campos_listado,"Cancelar");	 
        array_push($this->campos_listado,"Consultar");
        array_push($this->campos_listado,"Imprimir");
