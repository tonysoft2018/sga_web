<?php
// ----------------------------------------------------------------------------------
// ambiente_datosdelaempresa.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_DatosDeLaEmpresa_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_datosdelaempresa";
     private $NombreDeLaVista = "tbl_ambiente_datosdelaempresa";
     private $NombreCampoLlave ="nIDDatosDeLaEmpresa";
	 private $NombreCampoOrdenamiento="nIDDatosDeLaEmpresa";
	 private $NombreCampoParaNoRepetir="RazonSocial";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios_leyendas,"ID de los datos de la empresa"); 
		array_push($this->campos_obligatorios_leyendas,"Nombre de la Razon Social"); 
