...
class cltbl_Ambiente_Logo_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_logo";
     private $NombreDeLaVista = "tbl_ambiente_logo";
     private $NombreCampoLlave ="nIDLogo";
	 private $NombreCampoOrdenamiento="nIDLogo";
	 private $NombreCampoParaNoRepetir="Logo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Logo");		 
		...
		array_push($this->campos_obligatorios_leyendas,"Logo de la App"); 
		...
		array_push($this->campos_norepetir,"Logo");  		 
