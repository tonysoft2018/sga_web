<?php
// ----------------------------------------------------------------------------------
// ambiente_modulos.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_Modulos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_modulos";
     private $NombreDeLaVista = "tbl_ambiente_modulos_view";
     private $NombreCampoLlave ="nIDModulo";
	 private $NombreCampoOrdenamiento="Nivel,Orden";
	 private $NombreCampoParaNoRepetir="NombreDelModulo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"NombreDelModulo");		
		array_push($this->campos_obligatorios,"URL");	
        array_push($this->campos_obligatorios,"Modulo");		 
        array_push($this->campos_obligatorios,"Menu");	
        array_push($this->campos_obligatorios,"Nivel");	
        array_push($this->campos_obligatorios,"Orden");		       	 
		 
		//** TIPOS */		
		unset($this->campos_obligatorios_tipo);
		$this->campos_obligatorios_tipo=array();
		array_push($this->campos_obligatorios_tipo,"CADENA"); // CADENA/NUMERO/DECIMAL/FECHA
		array_push($this->campos_obligatorios_tipo,"CADENA"); // CADENA/NUMERO/DECIMAL/FECHA
        array_push($this->campos_obligatorios_tipo,"CADENA"); // CADENA/NUMERO/DECIMAL/FECHA
        array_push($this->campos_obligatorios_tipo,"CADENA"); // CADENA/NUMERO/DECIMAL/FECHA
        array_push($this->campos_obligatorios_tipo,"CADEMA"); // CADENA/NUMERO/DECIMAL/FECHA
        array_push($this->campos_obligatorios_tipo,"NUMERO"); // CADENA/NUMERO/DECIMAL/FECHA
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre del Modulo"); 
		array_push($this->campos_obligatorios_leyendas,"Direccion URL a donde se dirige el Modulo"); 
        array_push($this->campos_obligatorios_leyendas,"Identificacion del Modulo"); 
        array_push($this->campos_obligatorios_leyendas,"Nombre del Menu"); 
        array_push($this->campos_obligatorios_leyendas,"Nivel del Menu");
        array_push($this->campos_obligatorios_leyendas,"Orden en el Menu"); 
		...
		array_push($this->campos_norepetir,"NombreDelModulo");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Modulo");		
        array_push($this->campos_listado,"Menu");	
        array_push($this->campos_listado,"Nivel");	
        array_push($this->campos_listado,"Orden");
        array_push($this->campos_listado,"Padre_Menu");		        			 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Modulo");	
        array_push($this->campos_busqueda,"Menu");			 
        array_push($this->campos_busqueda,"Nivel");
        array_push($this->campos_busqueda,"Orden");              

		unset($this->campos_busqueda_tipo);
		$this->campos_busqueda_tipo=array();
		
		// CADENA/NUMERO/DECIMAL/FECHA
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"Mostrar");
		array_push($this->campos_especiales,"Creacion");
		array_push($this->campos_especiales,"Editar");
		array_push($this->campos_especiales,"Borrar");
		array_push($this->campos_especiales,"Cancelar");
		array_push($this->campos_especiales,"Consultar");
		array_push($this->campos_especiales,"Listar");
		array_push($this->campos_especiales,"Ejecutar");
		array_push($this->campos_especiales,"Imprimir");
		array_push($this->campos_especiales,"Etiquetas");
		array_push($this->campos_especiales,"CargaMasiva");
		array_push($this->campos_especiales,"ExportarExcel");
		array_push($this->campos_especiales,"ExportarPDF");

		array_push($this->campos_especiales,"Web");
		array_push($this->campos_especiales,"App");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"NombreDelModulo");		 		 	 
	 }
	 // --------------------------------------------------------
