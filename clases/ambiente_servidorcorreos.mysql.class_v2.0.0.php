<?php
// ----------------------------------------------------------------------------------
// ambiente_servidorcorreos.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Ambiente_ServidorCorreos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_servidorcorreos";
     private $NombreDeLaVista = "tbl_ambiente_servidorcorreos";
     private $NombreCampoLlave ="nIDCorreo";
	 private $NombreCampoOrdenamiento="nIDCorreo";
	 private $NombreCampoParaNoRepetir="Correo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Correo");		
		array_push($this->campos_obligatorios,"ServidorCorreoSalida");	
        array_push($this->campos_obligatorios,"Usuario");		 
        array_push($this->campos_obligatorios,"Password");		 
        array_push($this->campos_obligatorios,"PuertoSalida");		 
        array_push($this->campos_obligatorios,"CorreoOrigen");	
        array_push($this->campos_obligatorios,"TipoSalida");		 
        ...
        array_push($this->campos_obligatorios_comparativa1,"SIN COMPARAR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        array_push($this->campos_obligatorios_comparativa1,"SIN COMPARAR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        array_push($this->campos_obligatorios_comparativa1,"COMPARADO CON");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre del buzon"); 
		array_push($this->campos_obligatorios_leyendas,"Direccion o dominio del servidor de Correo"); 
        array_push($this->campos_obligatorios_leyendas,"Nombre del usuario"); 
        array_push($this->campos_obligatorios_leyendas,"Password del correo"); 
        array_push($this->campos_obligatorios_leyendas,"Puerto Logico de Salida"); 
        array_push($this->campos_obligatorios_leyendas,"Cuenta del correo de Salida"); 
        array_push($this->campos_obligatorios_leyendas,"Tipo de Salida"); 
        ...
        array_push($this->campos_obligatorios_valorescomparar1,"SMTP");   
        array_push($this->campos_obligatorios_valorescomparar1,"OTRO");   
		...
		array_push($this->campos_norepetir,"Correo");  	 
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"UtilizarSSL");
		array_push($this->campos_especiales,"UtilizarAutentificacion");
