...
class cltbl_Canjes_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_canjes_deta";
     private $NombreDeLaVista = "tbl_canjes_deta_view";
     private $NombreCampoLlave ="nIDCanje_Deta";
	 private $NombreCampoOrdenamiento="nIDCanje_Deta";
	 private $NombreCampoParaNoRepetir="nIDCanje_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDCanje");
        array_push($this->campos_obligatorios,"nIDProducto");
        array_push($this->campos_obligatorios,"Cantidad");
        array_push($this->campos_obligatorios,"Puntos");		
        ...
        array_push($this->campos_obligatorios_rango2,"");  
        array_push($this->campos_obligatorios_rango2,0);  
        array_push($this->campos_obligatorios_rango2,0);  
		...
		array_push($this->campos_obligatorios_leyendas,"No tiene ID del Encabezado"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene ID del Producto"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene Cantidad"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene Puntos"); 
        ...
        array_push($this->campos_norepetir,"nIDCanje_Deta");  		 
        array_push($this->campos_norepetir,"nIDProducto");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Puntos");	          
	 ...
	 public function Cargar_Campos_Especiales(){	 
        ...
        //array_push($this->campos_especiales,"TodosLosCentrosDeServicio");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"Clasificacion");		 		 	 
	 }
	 // --------------------------------------------------------
	...
	private function ActualizarLeidos($l_nID, $l_Cantidad, $l_Observaciones){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtInsercion = "UPDATE " .  $this->NombreDeLaTabla;
		$txtInsercion = $txtInsercion . " SET ";
		$txtInsercion = $txtInsercion . " Leidos=" . $l_Cantidad . ",";
	...
	public function CambiarLeidos($l_nID, $l_Cantidad, $l_Observaciones ){
		if($this->bandTieneAlgunError){
		   return FALSE;
		}
		...
		if ($this->ActualizarLeidos($l_nID,$l_Cantidad,$l_Observaciones)==TRUE){
			return TRUE;
		} else {
			return FALSE;
		}
