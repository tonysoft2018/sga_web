...
class cltbl_Canjes_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_canjes_enca";
     private $NombreDeLaVista = "tbl_canjes_enca_view";
     private $NombreCampoLlave ="nIDCanje";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"nIDCat_Cliente");
		array_push($this->campos_obligatorios,"nIDCat_CentroDeServicio");	
		...
		array_push($this->campos_obligatorios_leyendas,"Cliente");	
		array_push($this->campos_obligatorios_leyendas,"Centro de Servicio");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"CentroDeServicio");
		array_push($this->campos_listado,"Creador");	 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
        ...
        array_push($this->campos_busqueda,"CentroDeServicio");   
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Cliente");		 	 
	 }
	 // --------------------------------------------------------
