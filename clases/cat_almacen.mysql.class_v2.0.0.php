...
class cltbl_Cat_Almacen_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_almacen";
     private $NombreDeLaVista = "tbl_cat_almacen_view";
     private $NombreCampoLlave ="nIDCat_Almacen";
	 private $NombreCampoOrdenamiento="Almacen";
	 private $NombreCampoParaNoRepetir="IDAlmacen";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDAlmacen");
		array_push($this->campos_obligatorios,"Almacen");		 
		array_push($this->campos_obligatorios,"nIDCat_Empresa");		 
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Almacen"); 
		array_push($this->campos_obligatorios_leyendas,"Almacen");	
		array_push($this->campos_obligatorios_leyendas,"Empresa");	
		...
		array_push($this->campos_obligatorios_mostrarleyenda,"NO");	
		array_push($this->campos_obligatorios_mostrarleyenda,"NO");

		unset($this->campos_obligatorios_valorescomparar1);
		$this->campos_obligatorios_valorescomparar1=array();			 
		array_push($this->campos_obligatorios_valorescomparar1,"HOLA");  // SI,NO
		array_push($this->campos_obligatorios_valorescomparar1,"MUNDO");	
		
		unset($this->campos_obligatorios_valorescomparar2);
		$this->campos_obligatorios_valorescomparar2=array();			 
		array_push($this->campos_obligatorios_valorescomparar2,"HOLA");  // SI,NO
		array_push($this->campos_obligatorios_valorescomparar2,"MUNDO");
		
		// Campos no repetir
		unset($this->campos_norepetir);
		$this->campos_norepetir=array();			 
		array_push($this->campos_norepetir,"IDAlmacen");  
		array_push($this->campos_norepetir,"Almacen");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDAlmacen");
		...
		array_push($this->campos_listado_importacion,"IDAlmacen");
		array_push($this->campos_listado_importacion,"Almacen");	
		array_push($this->campos_listado_importacion,"Descripcion");	
		array_push($this->campos_listado_importacion,"bPerteneceCentroServicio");	 
		array_push($this->campos_listado_importacion,"Empresa");
		array_push($this->campos_listado_importacion,"CentroDeServicio");		
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDAlmacen");
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"bPerteneceCentroServicio");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDAlmacen");	
