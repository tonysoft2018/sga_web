...
class cltbl_Cat_CentrosDeServicio_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_centrosdeservicio";
     private $NombreDeLaVista = "tbl_cat_centrosdeservicio";
     private $NombreCampoLlave ="nIDCat_CentroDeServicio";
	 private $NombreCampoOrdenamiento="CentroDeServicio";
	 private $NombreCampoParaNoRepetir="IDCentroDeServicio";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDCentroDeServicio");
		array_push($this->campos_obligatorios,"CentroDeServicio");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID");  
		...
		array_push($this->campos_norepetir,"IDCentroDeServicio");  
		array_push($this->campos_norepetir,"CentroDeServicio");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDCentroDeServicio");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDCentroDeServicio");
		array_push($this->campos_combo,"CentroDeServicio");		 	 
	 }
	 // --------------------------------------------------------
