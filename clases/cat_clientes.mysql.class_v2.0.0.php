...
class cltbl_Cat_Clientes_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_clientes";
     private $NombreDeLaVista = "tbl_cat_clientes";
     private $NombreCampoLlave ="nIDCat_Cliente";
	 private $NombreCampoOrdenamiento="RazonSocial";
	 private $NombreCampoParaNoRepetir="IDCliente";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDCliente");
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Cliente"); 
		...
		array_push($this->campos_norepetir,"IDCliente");  
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDCliente");
		...
		array_push($this->campos_listado_importacion,"IDCliente");
		array_push($this->campos_listado_importacion,"IZeta");
		array_push($this->campos_listado_importacion,"RazónSocial");	
		...
		array_push($this->campos_listado_importacion,"Teléfono1");
		array_push($this->campos_listado_importacion,"Teléfono2");
		array_push($this->campos_listado_importacion,"Teléfono3");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDCliente");
