<?php
// ----------------------------------------------------------------------------------
// cat_conceptosentrada.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_ConceptosEntrada_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_conceptosentrada";
     private $NombreDeLaVista = "tbl_cat_conceptosentrada";
     private $NombreCampoLlave ="nIDCat_ConceptoEntrada";
	 private $NombreCampoOrdenamiento="ConceptoEntrada";
	 private $NombreCampoParaNoRepetir="IDConceptoEntrada";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDConceptoEntrada");
		array_push($this->campos_obligatorios,"ConceptoEntrada");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Concepto de Entrada"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Concepto de Entrada");
		...
		array_push($this->campos_norepetir,"IDConceptoEntrada");  
		array_push($this->campos_norepetir,"ConceptoEntrada");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDConceptoEntrada");
		array_push($this->campos_listado,"ConceptoEntrada");		 

		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDConceptoEntrada");
		array_push($this->campos_listado_importacion,"ConceptoEntrada");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDConceptoEntrada");
		array_push($this->campos_busqueda,"ConceptoEntrada");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDConceptoEntrada");		 
		array_push($this->campos_combo,"ConceptoEntrada");		 	 
	 }
	 // --------------------------------------------------------
