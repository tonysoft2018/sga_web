<?php
// ----------------------------------------------------------------------------------
// cat_conceptossalida.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_ConceptosSalida_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_conceptossalida";
     private $NombreDeLaVista = "tbl_cat_conceptossalida";
     private $NombreCampoLlave ="nIDCat_ConceptoSalida";
	 private $NombreCampoOrdenamiento="ConceptoSalida";
	 private $NombreCampoParaNoRepetir="IDConceptoSalida";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDConceptoSalida");
		array_push($this->campos_obligatorios,"ConceptoSalida");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Concepto de Salida"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Concepto de Salida");
		...
		array_push($this->campos_norepetir,"IDConceptoSalida");  
		array_push($this->campos_norepetir,"ConceptoSalida");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDConceptoSalida");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDConceptoSalida");
		array_push($this->campos_busqueda,"ConceptoSalida");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDConceptoSalida");	
