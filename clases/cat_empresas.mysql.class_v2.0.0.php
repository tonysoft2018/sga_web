...
class cltbl_Cat_Empresas_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_empresas";
     private $NombreDeLaVista = "tbl_cat_empresas";
     private $NombreCampoLlave ="nIDCat_Empresa";
	 private $NombreCampoOrdenamiento="RazonSocial";
	 private $NombreCampoParaNoRepetir="ID";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"ID");
		...
		array_push($this->campos_obligatorios_leyendas,"ID de la Empresa"); 
		...
		array_push($this->campos_norepetir,"ID");  
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"ID");
		...
		array_push($this->campos_listado_importacion,"ID");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"ID");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"ID");	
