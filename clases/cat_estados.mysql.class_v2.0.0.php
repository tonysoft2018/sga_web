...
class cltbl_Cat_Estados_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_estados";
     private $NombreDeLaVista = "tbl_cat_estados";
     private $NombreCampoLlave ="nIDCat_Estado";
	 private $NombreCampoOrdenamiento="Estado";
	 private $NombreCampoParaNoRepetir="IDEstado";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDEstado");
		array_push($this->campos_obligatorios,"Estado");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Estado"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Estado de Inspeccion");
		...
		array_push($this->campos_norepetir,"IDEstado");  
		array_push($this->campos_norepetir,"Estado");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDEstado");
		array_push($this->campos_listado,"Estado");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDEstado");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDEstado");
		array_push($this->campos_busqueda,"Estado");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"IDEstado");
		array_push($this->campos_combo,"Estado");		 	 
	 }
	 // --------------------------------------------------------
