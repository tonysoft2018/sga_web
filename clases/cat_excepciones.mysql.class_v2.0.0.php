<?php
// ----------------------------------------------------------------------------------
// cat_excepciones.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_Excepciones_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_excepciones";
     private $NombreDeLaVista = "tbl_cat_excepciones";
     private $NombreCampoLlave ="nIDCat_Excepcion";
	 private $NombreCampoOrdenamiento="Excepcion";
	 private $NombreCampoParaNoRepetir="IDExcepcion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDExcepcion");
		array_push($this->campos_obligatorios,"Excepcion");		
		...
		array_push($this->campos_obligatorios_leyendas,"ID de la Excepcion"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura de la Excepcion");
		...
		array_push($this->campos_norepetir,"IDExcepcion");  
		array_push($this->campos_norepetir,"Excepcion");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDExcepcion");
		array_push($this->campos_listado,"Excepcion");		 

		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDExcepcion");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDExcepcion");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDExcepcion");		 
		array_push($this->campos_combo,"Excepcion");		 	 
	 }
	 // --------------------------------------------------------
