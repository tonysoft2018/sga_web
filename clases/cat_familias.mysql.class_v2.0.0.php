...
class cltbl_Cat_Familias_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_familias";
     private $NombreDeLaVista = "tbl_cat_familias";
     private $NombreCampoLlave ="nIDCat_Familia";
	 private $NombreCampoOrdenamiento="Familia";
	 private $NombreCampoParaNoRepetir="IDFamilia";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDFamilia");
		array_push($this->campos_obligatorios,"Familia");		
		...
		array_push($this->campos_obligatorios_leyendas,"ID de la Familia"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura de la Familia del Producto");
		...
		array_push($this->campos_norepetir,"IDFamilia");  
		array_push($this->campos_norepetir,"Familia");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDFamilia");
		array_push($this->campos_listado,"Familia");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDFamilia");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDFamilia");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDFamilia");	
		array_push($this->campos_combo,"Familia");		 	 
	 }
	 // --------------------------------------------------------
