...
class cltbl_Cat_Matriz_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_matriz";
     private $NombreDeLaVista = "tbl_cat_matriz_view";
     private $NombreCampoLlave ="nIDCat_Matriz";
	 private $NombreCampoOrdenamiento="RazonSocial, Almacen, Pasillo, Rack, Nivel, SubNivel, Columna";
	 private $NombreCampoParaNoRepetir="IDMatriz";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDMatriz");
		array_push($this->campos_obligatorios,"Matriz");		 
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre de la Matriz");	
		...
		array_push($this->campos_norepetir,"IDMatriz");  
		array_push($this->campos_norepetir,"Matriz");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDMatriz");
		array_push($this->campos_listado,"Matriz");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDMatriz");
		array_push($this->campos_busqueda,"Matriz");	
		...
		array_push($this->campos_busqueda,"Pasillo");	
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDMatriz");		 	  
		array_push($this->campos_combo,"Matriz");		 	 
	 }
	 // --------------------------------------------------------
