<?php
// ----------------------------------------------------------------------------------
// cat_motivotraspaso.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_MotivosTraspaso_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_motivostraspaso";
     private $NombreDeLaVista = "tbl_cat_motivostraspaso";
     private $NombreCampoLlave ="nIDCat_MotivosTraspaso";
	 private $NombreCampoOrdenamiento="Motivo";
	 private $NombreCampoParaNoRepetir="IDMotivoTraspaso";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDMotivoTraspaso");
		array_push($this->campos_obligatorios,"Motivo");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Motivo de Traspaso"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Motivo de Traspaso");
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDMotivoTraspaso");
		array_push($this->campos_listado,"Motivo");		 

		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDMotivoTraspaso");
		array_push($this->campos_listado_importacion,"Motivo");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDMotivoTraspaso");
		array_push($this->campos_busqueda,"Motivo");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDMotivoTraspaso");
		array_push($this->campos_combo,"Motivo");		 	 
	 }
	 // --------------------------------------------------------
