...
class cltbl_Cat_Pasillos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_pasillos";
     private $NombreDeLaVista = "tbl_cat_pasillos";
     private $NombreCampoLlave ="nIDCat_Pasillo";
	 private $NombreCampoOrdenamiento="Pasillo";
	 private $NombreCampoParaNoRepetir="IDPasillo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDPasillo");
		array_push($this->campos_obligatorios,"Pasillo");
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Pasillo"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Pasillo");
		...
		array_push($this->campos_norepetir,"IDPasillo");  
		array_push($this->campos_norepetir,"Pasillo");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDPasillo");
		array_push($this->campos_listado,"Pasillo");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDPasillo");
		array_push($this->campos_listado_importacion,"Pasillo");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDPasillo");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDPasillo");
