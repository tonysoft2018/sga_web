<?php
// ----------------------------------------------------------------------------------
// cat_presentaciones.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_Presentaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_presentaciones";
     private $NombreDeLaVista = "tbl_cat_presentaciones";
     private $NombreCampoLlave ="nIDCat_Presentacion";
	 private $NombreCampoOrdenamiento="Presentacion";
	 private $NombreCampoParaNoRepetir="IDPresentacion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDPresentacion");
		array_push($this->campos_obligatorios,"Presentacion");		 
		...
		array_push($this->campos_obligatorios_leyendas,"ID de la Presentacion"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura de la Presentación");
		...
		array_push($this->campos_norepetir,"IDPresentacion");  
		array_push($this->campos_norepetir,"Presentacion");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDPresentacion");
		array_push($this->campos_listado,"Presentacion");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDPresentacion");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDPresentacion");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDPresentacion");		 	  
		array_push($this->campos_combo,"Presentacion");		 	 
	 }
	 // --------------------------------------------------------
