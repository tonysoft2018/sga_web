...
class cltbl_Cat_Productos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_productos";
     private $NombreDeLaVista = "tbl_cat_productos_view";
     private $NombreCampoLlave ="nIDProducto";
	 private $NombreCampoOrdenamiento="Producto";
	 private $NombreCampoParaNoRepetir="Codigo_IZeta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Codigo_IZeta");		 
		array_push($this->campos_obligatorios,"Producto");		 		 	 
		array_push($this->campos_obligatorios,"UnidadDeMedida");		 		 	 
		...
		array_push($this->campos_obligatorios_leyendas,"Codigo IZeta");	
		array_push($this->campos_obligatorios_leyendas,"Producto");	
		array_push($this->campos_obligatorios_leyendas,"Unidad de Medida");			 
		...
		array_push($this->campos_norepetir,"Codigo_IZeta");			
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Descripcion");	
		array_push($this->campos_listado,"UnidadDeMedida");			 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"Id Producto");	 
		array_push($this->campos_listado_importacion,"Codigo_SAP");	
		array_push($this->campos_listado_importacion,"Codigo_IZeta");	
		array_push($this->campos_listado_importacion,"Producto");	 
		array_push($this->campos_listado_importacion,"Descripcion");
		array_push($this->campos_listado_importacion,"Tipo");	
		array_push($this->campos_listado_importacion,"SubTipo");
		array_push($this->campos_listado_importacion,"Familia");	
		array_push($this->campos_listado_importacion,"Presentacion");
		array_push($this->campos_listado_importacion,"Excepcion");
		array_push($this->campos_listado_importacion,"UnidadDeMedida");
		array_push($this->campos_listado_importacion,"Proveedor");								
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDProducto");	 
		array_push($this->campos_busqueda,"Codigo_SAP");	
		...
		array_push($this->campos_busqueda,"Tipo");	
		array_push($this->campos_busqueda,"SubTipo");	
		array_push($this->campos_busqueda,"Familia");	
		array_push($this->campos_busqueda,"Presentacion");	
		array_push($this->campos_busqueda,"Excepcion");	
		array_push($this->campos_busqueda,"UnidadDeMedida");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Codigo_IZeta");		 	 
	 }
	 // --------------------------------------------------------
