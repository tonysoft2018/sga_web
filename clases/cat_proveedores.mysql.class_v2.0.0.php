<?php
// ----------------------------------------------------------------------------------
// cat_proveedores.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_Proveedores_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_proveedores";
     private $NombreDeLaVista = "tbl_cat_proveedores";
     private $NombreCampoLlave ="nIDCat_Proveedor";
	 private $NombreCampoOrdenamiento="RazonSocial";
	 private $NombreCampoParaNoRepetir="IDProveedor";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDProveedor");
		array_push($this->campos_obligatorios,"RazonSocial");
		array_push($this->campos_obligatorios,"Contacto");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Proveedor"); 
		array_push($this->campos_obligatorios_leyendas,"Razón Social"); 
		array_push($this->campos_obligatorios_leyendas,"Nombre del Contacto");
		...
		array_push($this->campos_norepetir,"IDProveedor");  
		array_push($this->campos_norepetir,"RazonSocial");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDProveedor");
		array_push($this->campos_listado,"RazonSocial");	
		array_push($this->campos_listado,"Telefono1");	
		array_push($this->campos_listado,"Celular1");	
		array_push($this->campos_listado,"Email1");	
		array_push($this->campos_listado,"Contacto");	
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDProvedor");
		array_push($this->campos_listado_importacion,"IZeta");
		array_push($this->campos_listado_importacion,"RazonSocial");	
		array_push($this->campos_listado_importacion,"RFC");
		array_push($this->campos_listado_importacion,"Calle");
		array_push($this->campos_listado_importacion,"NoExterior");
		array_push($this->campos_listado_importacion,"NoInterior");
		array_push($this->campos_listado_importacion,"Colonia");
		array_push($this->campos_listado_importacion,"Ciudad");
		array_push($this->campos_listado_importacion,"Municipio");
		array_push($this->campos_listado_importacion,"Estado");
		array_push($this->campos_listado_importacion,"Pais");
		array_push($this->campos_listado_importacion,"CP");
		array_push($this->campos_listado_importacion,"Telefono1");
		array_push($this->campos_listado_importacion,"Telefono2");
		array_push($this->campos_listado_importacion,"Telefono3");
		array_push($this->campos_listado_importacion,"Celular1");
		array_push($this->campos_listado_importacion,"Celular2");
		array_push($this->campos_listado_importacion,"Celular3");
		array_push($this->campos_listado_importacion,"Email1");
		array_push($this->campos_listado_importacion,"Email2");
		array_push($this->campos_listado_importacion,"Email3");
		array_push($this->campos_listado_importacion,"Contacto");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDProveedor");
		array_push($this->campos_busqueda,"RazonSocial");	
		array_push($this->campos_busqueda,"Telefono1");	
		array_push($this->campos_busqueda,"Celular1");	
		array_push($this->campos_busqueda,"Email1");	
		array_push($this->campos_busqueda,"Contacto");	
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDProveedor");	
