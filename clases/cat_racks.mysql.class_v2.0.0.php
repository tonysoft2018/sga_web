...
class cltbl_Cat_Racks_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_racks";
     private $NombreDeLaVista = "tbl_cat_racks";
     private $NombreCampoLlave ="nIDCat_Rack";
	 private $NombreCampoOrdenamiento="Rack";
	 private $NombreCampoParaNoRepetir="IDRack";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDRack");
		array_push($this->campos_obligatorios,"Rack");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Rack"); 
		array_push($this->campos_obligatorios_leyendas,"Nombre del Rack");
		...
		array_push($this->campos_norepetir,"IDRack");  
		array_push($this->campos_norepetir,"Rack");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDRack");
		...
		array_push($this->campos_listado_importacion,"IDRack");
		array_push($this->campos_listado_importacion,"Rack");	
		array_push($this->campos_listado_importacion,"Descripciuon");	
		array_push($this->campos_listado_importacion,"Columna");	
		array_push($this->campos_listado_importacion,"Nivel");	 
		array_push($this->campos_listado_importacion,"SubNivel");	 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDRack");
		array_push($this->campos_busqueda,"Rack");			 
		array_push($this->campos_busqueda,"Columna");	
		array_push($this->campos_busqueda,"Nivel");			 		 
		array_push($this->campos_busqueda,"SubNivel");			 

		unset($this->campos_busqueda_tipo);
		$this->campos_busqueda_tipo=array();
		
		array_push($this->campos_busqueda_tipo,"CADENA"); // CADENA/NUMERO/FECHA/DECIMAL
		array_push($this->campos_busqueda_tipo,"CADENA");	
		array_push($this->campos_busqueda_tipo,"NUMERO");	
		array_push($this->campos_busqueda_tipo,"CADENA");	
		array_push($this->campos_busqueda_tipo,"CADENA");		
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"IDRack");		 
		array_push($this->campos_combo,"Rack");			 
		array_push($this->campos_combo,"Columna");			 
		array_push($this->campos_combo,"Nivel");			 
		array_push($this->campos_combo,"SubNivel");			 
