...
class cltbl_Cat_SubTipos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_subtipos";
     private $NombreDeLaVista = "tbl_cat_subtipos";
     private $NombreCampoLlave ="nIDCat_SubTipo";
	 private $NombreCampoOrdenamiento="SubTipo";
	 private $NombreCampoParaNoRepetir="IDSubTipo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDSubTipo");
		array_push($this->campos_obligatorios,"SubTipo");	
		...
		array_push($this->campos_obligatorios_leyendas,"ID del SubTipo"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del SubTipo de Producto");
		...
		array_push($this->campos_norepetir,"IDSubTipo");  
		array_push($this->campos_norepetir,"SubTipo");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDSubTipo");
		array_push($this->campos_listado,"SubTipo");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	

		array_push($this->campos_listado_importacion,"IDSubTipo");
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDSubTipo");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDSubTipo");		 
		array_push($this->campos_combo,"SubTipo");		 	 
	 }
	 // --------------------------------------------------------
