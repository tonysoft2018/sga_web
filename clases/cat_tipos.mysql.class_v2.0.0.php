...
class cltbl_Cat_Tipos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_tipos";
     private $NombreDeLaVista = "tbl_cat_tipos";
     private $NombreCampoLlave ="nIDCat_Tipo";
	 private $NombreCampoOrdenamiento="Tipo";
	 private $NombreCampoParaNoRepetir="IDTipo";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDTipo");
		...
		array_push($this->campos_obligatorios_leyendas,"ID del Tipo"); 
		array_push($this->campos_obligatorios_leyendas,"Nomenclatura del Tipo de Producto");
		...
		array_push($this->campos_norepetir,"IDTipo");  
		array_push($this->campos_norepetir,"Tipo");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDTipo");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"IDTipo");		
		array_push($this->campos_combo,"Tipo");		 	 
	 }
	 // --------------------------------------------------------
