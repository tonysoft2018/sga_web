<?php
// ----------------------------------------------------------------------------------
// cat_unidadesdemedida.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Cat_UnidadesDeMedida_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_unidadesdemedida";
     private $NombreDeLaVista = "tbl_cat_unidadesdemedida";
     private $NombreCampoLlave ="nIDCat_UnidadDeMedida";
	 private $NombreCampoOrdenamiento="UnidadDeMedida";
	 private $NombreCampoParaNoRepetir="UnidadDeMedida";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre de la unida de Medida"); 
		...
		array_push($this->campos_norepetir,"UnidadDeMedida");  
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"UnidadDeMedida");		 	 
	 }
	 // --------------------------------------------------------
