<?php
// ----------------------------------------------------------------------------------
// cat_centrosdeservicio.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Contenedores_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_contenedor";
     private $NombreDeLaVista = "tbl_contenedor_view";
     private $NombreCampoLlave ="nIDContenedor";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"NoFactura");		 
		...
		array_push($this->campos_obligatorios_leyendas,"Folio de Factura");		 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"NoFactura");		 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Realizo");	
        array_push($this->campos_busqueda,"Fecha");	
        array_push($this->campos_busqueda,"Proveedor");			 
        array_push($this->campos_busqueda,"NoFactura");	
