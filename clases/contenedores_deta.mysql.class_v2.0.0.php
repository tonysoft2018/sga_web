<?php
// ----------------------------------------------------------------------------------
// contenedor_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Contenedor_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_contenedor_deta";
     private $NombreDeLaVista = "tbl_contenedor_deta";
     private $NombreCampoLlave ="nIDContenedor_Deta";
	 private $NombreCampoOrdenamiento="nIDContenedor_Deta";
	 private $NombreCampoParaNoRepetir="nIDContenedor_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"Parts_Name");	
        array_push($this->campos_obligatorios,"Cantidad");		
        array_push($this->campos_obligatorios,"PrecioDividido");	
        ...
        array_push($this->campos_obligatorios_comparativa1,"SIN COMPARAR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        array_push($this->campos_obligatorios_comparativa1,"MAYORIGUAL");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        array_push($this->campos_obligatorios_comparativa1,"MAYORIGUAL");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        ...
        array_push($this->campos_obligatorios_rango2,"");  
        array_push($this->campos_obligatorios_rango2,100000);  
        array_push($this->campos_obligatorios_rango2,100000);  
		...
		array_push($this->campos_obligatorios_leyendas,"No tiene Codigo IZeta"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene Parts Name"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene Cantidad"); 
        array_push($this->campos_obligatorios_leyendas,"No tiene PrecioDividido"); 
		...
		array_push($this->campos_norepetir,"nIDContenedor_Deta");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Codigo_SAP");		
        array_push($this->campos_listado,"Parts_Name");	 
        array_push($this->campos_listado,"Cantidad");	 
        array_push($this->campos_listado,"PrecioDividido");	          
	 ...
	 public function Cargar_Campos_Busqueda(){	 
        ...
        array_push($this->campos_busqueda,"Parts_Name");
