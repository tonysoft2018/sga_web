<?php
// ----------------------------------------------------------------------------------
// entradasporotrosconceptos.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_EntradaPorOtrosConceptos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_entradaporotrosconceptos";
     private $NombreDeLaVista = "tbl_entradaporotrosconceptos_view";
     private $NombreCampoLlave ="nIDEntradaPorOtrosConceptos";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"nIDCat_Almacen");
		array_push($this->campos_obligatorios,"nIDCat_ConceptoEntrada");	
		...
		array_push($this->campos_obligatorios_leyendas,"Almacen");  
		array_push($this->campos_obligatorios_leyendas,"Concepto de Entrada");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"ConceptoEntrada");
	 ...
	 public function Cargar_Campos_Combo(){	 
        ...
        array_push($this->campos_combo,"ConceotoEntrada");
	 }
	 // --------------------------------------------------------
