<?php
// ----------------------------------------------------------------------------------
// entradasporotrosconceptos_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_EntradaPorOtrosConceptos_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_entradaporotrosconceptos_deta";
     private $NombreDeLaVista = "tbl_entradaporotrosconceptos_deta_view";
     private $NombreCampoLlave ="nIDEntradaPorOtrosConceptos_Deta";
	 private $NombreCampoOrdenamiento="nIDEntradaPorOtrosConceptos_Deta";
	 private $NombreCampoParaNoRepetir="nIDEntradaPorOtrosConceptos_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDEntradaPorOtrosConceptos");
		...
		array_push($this->campos_norepetir,"nIDEntradaPorOtrosConceptos_Deta");  		 
