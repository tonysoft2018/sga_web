...
class cltbl_Inspeccion_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_inspeccion";
     private $NombreDeLaVista = "tbl_inspeccion_view";
     private $NombreCampoLlave ="nIDInspeccion";
	 private $NombreCampoOrdenamiento="nIDInspeccion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDInspeccion");
		array_push($this->campos_obligatorios,"nIDPackingList_Deta");		
