...
class cltbl_Interfaces_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_interfaces";
     private $NombreDeLaVista = "tbl_interfaces_view";
     private $NombreCampoLlave ="nIDInterfaz";
	 private $NombreCampoOrdenamiento="Interfaz";
	 private $NombreCampoParaNoRepetir="Interfaz";
	 ...
	 public $posicion_compararI=array();
	 public $valores_compararI_1=array();
	 public $valores_compararI_2=array();
	 public $valores_compararI_3=array();
	 public $valores_compararI_4=array();
	 public $valores_compararI_5=array();
	 public $valores_compararI_6=array();
	 public $valores_compararI_7=array();
	 public $valores_compararI_8=array();
	 public $valores_compararI_9=array();
	 public $valores_compararI_10=array();

	 public $posicion_compararF=array();
	 public $valores_compararF_1=array();
	 public $valores_compararF_2=array();
	 public $valores_compararF_3=array();
	 public $valores_compararF_4=array();
	 public $valores_compararF_5=array();
	 public $valores_compararF_6=array();
	 public $valores_compararF_7=array();
	 public $valores_compararF_8=array();
	 public $valores_compararF_9=array();
	 public $valores_compararF_10=array();
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Interfaz");		 	
		array_push($this->campos_obligatorios,"nIDModulo");		 
		array_push($this->campos_obligatorios,"Funcion");	
		array_push($this->campos_obligatorios,"Tipo");		 		 
		...
		array_push($this->campos_obligatorios_rango2,999999);  		
		array_push($this->campos_obligatorios_rango2,"");  
		array_push($this->campos_obligatorios_rango2,"");  
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre de la Interfaz"); 		 
		array_push($this->campos_obligatorios_leyendas,"Modulo relacionado");	
		array_push($this->campos_obligatorios_leyendas,"Funcion a realizar");	
		array_push($this->campos_obligatorios_leyendas,"Tipo");	
		...
		array_push($this->campos_obligatorios_valorescomparar1,"ENVIO");  // SI,NO
		array_push($this->campos_obligatorios_valorescomparar1,"RECEPCION");  // SI,NO
		array_push($this->campos_obligatorios_valorescomparar1,"EJECUCION");  // SI,NO
		array_push($this->campos_obligatorios_valorescomparar1,"ENVIO/RECEPCION");  // SI,NO
		...
		unset($this->posicion_compararI);
		$this->posicion_compararI=array();			 
		...
		array_push($this->posicion_compararI,0); // Ej. Posicion 0: "Interfaz", si se carga un valor 0, indica que no tiene lista.
		array_push($this->posicion_compararI,0); // Ej. Posicion 1: "nIDModulo", si se carga un valor 0, indica que no tiene lista.
		array_push($this->posicion_compararI,1); // Ej. Posicion 2: "Funcion", si se carga un valor 0, indica que no tiene lista.
		array_push($this->posicion_compararI,2); // Ej. Posicion 3: "Tipo", si se carga un valor 0, indica que no tiene lista.

	 
		// Listas para comparar
		// Ejemplo campo:Funcion
		unset($this->valores_compararI_1);
		$this->valores_compararI_1=array();	
		array_push($this->valores_compararI_1,"ENVIO");		 
		array_push($this->valores_compararI_1,"RECEPCION");		 
		array_push($this->valores_compararI_1,"EJECUCION");		 
		array_push($this->valores_compararI_1,"ENVIO/RECEPCION");	
		array_push($this->valores_compararI_1,"TODOS");		 
 
		unset($this->valores_compararI_2);
		$this->valores_compararI_2=array();	
		array_push($this->valores_compararI_2,"WEB");		 
		array_push($this->valores_compararI_2,"APP");		 
		array_push($this->valores_compararI_2,"CLIENTE/SERVIDOR");	
	  
		// Campos no repetir
		unset($this->campos_norepetir);
		$this->campos_norepetir=array();			 
		array_push($this->campos_norepetir,"Interfaz");  		 

		unset($this->campos_norepetir_tipo);
		$this->campos_norepetir_tipo=array();			 
		array_push($this->campos_norepetir_tipo,"CADENA");   // CADENA/NUMERO/FECHA
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Interfaz");
		array_push($this->campos_listado,"Metodo");
		array_push($this->campos_listado,"NombreDelModulo");	
		array_push($this->campos_listado,"Funcion");			 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Interfaz");
		array_push($this->campos_busqueda,"Descripcion");	
		array_push($this->campos_busqueda,"API");	
		array_push($this->campos_busqueda,"Ubicacion");	
		array_push($this->campos_busqueda,"URL");	
		array_push($this->campos_busqueda,"Metodo");	
		array_push($this->campos_busqueda,"NombreDeLModulo");		
		array_push($this->campos_busqueda,"Funcion");			 	 

		unset($this->campos_busqueda_tipo);
		$this->campos_busqueda_tipo=array();
		
		// CADENA/NUMERO/FECHA
		array_push($this->campos_busqueda_tipo,"CADENA"); 
		array_push($this->campos_busqueda_tipo,"CADENA");	
		array_push($this->campos_busqueda_tipo,"CADENA");	
		array_push($this->campos_busqueda_tipo,"CADENA");
		array_push($this->campos_busqueda_tipo,"CADENA");
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"PasarDatos");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Interfaz");		 	 
	 }
	 // --------------------------------------------------------
