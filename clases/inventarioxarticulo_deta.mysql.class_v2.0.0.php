...
class cltbl_InventarioXArticulo_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_inventarioxarticulo_deta";
     private $NombreDeLaVista = "tbl_inventarioxarticulo_deta_view";
     private $NombreCampoLlave ="nIDIxA_Deta";
	 private $NombreCampoOrdenamiento="nIDIxA_Deta";
	 private $NombreCampoParaNoRepetir="nIDIxA_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDIxA");         	
