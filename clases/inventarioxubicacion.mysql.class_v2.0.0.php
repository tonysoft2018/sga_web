<?php
// ----------------------------------------------------------------------------------
// invnetarioxubicacion.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_InventarioXUbicacion_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_inventarioxubicacion";
     private $NombreDeLaVista = "tbl_inventarioxubicacion_view";
     private $NombreCampoLlave ="nIDIxU";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDCat_Rack");
        ...
        array_push($this->campos_obligatorios_leyendas,"Catalogo de Almacen");	
        array_push($this->campos_obligatorios_leyendas,"Catalogo de Racks");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Almacen");	
        array_push($this->campos_busqueda,"Fecha");		
        array_push($this->campos_busqueda,"Rack");			 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Fecha");	
		array_push($this->campos_combo,"Estatus");		 	 
	 }
	 // --------------------------------------------------------
