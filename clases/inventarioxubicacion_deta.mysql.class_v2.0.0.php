<?php
// ----------------------------------------------------------------------------------
// inventarioxubicacion_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_InventarioXUbicacion_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_inventarioxubicacion_deta";
     private $NombreDeLaVista = "tbl_inventarioxubicacion_deta_view";
     private $NombreCampoLlave ="nIDIxU_Deta";
	 private $NombreCampoOrdenamiento="nIDIxU_Deta";
	 private $NombreCampoParaNoRepetir="nIDIxU_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDIxU");              	
        array_push($this->campos_obligatorios,"nIDProducto");
        array_push($this->campos_obligatorios,"nIDUbicacion");		
        ...
        array_push($this->campos_obligatorios_leyendas,"No tiene Ubicacion");         
		...
		array_push($this->campos_norepetir,"nIDIxA_Deta");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Estado");	 
		array_push($this->campos_listado,"Existencia");	          
		array_push($this->campos_listado,"Conteo");	          
		array_push($this->campos_listado,"Diferencia");	          
