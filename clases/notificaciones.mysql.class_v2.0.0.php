<?php
// ----------------------------------------------------------------------------------
// notificaciones.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Notificaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ambiente_notificaciones";
     private $NombreDeLaVista = "tbl_ambiente_notificaciones_view";
     private $NombreCampoLlave ="nIDNotificacion";
	 private $NombreCampoOrdenamiento="Notificacion";
	 private $NombreCampoParaNoRepetir="nIDNotificacion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"Notificacion");
        ...
        array_push($this->campos_obligatorios_leyendas,"Notificacion");		 		 
        ...
        array_push($this->campos_norepetir,"Notificacion");  	
	 ...
	 public function Cargar_Campos_Listado(){	 
        ...
        array_push($this->campos_listado,"Notificacion");	
	 ...
	 public function Cargar_Campos_Busqueda(){	 
        ...
        array_push($this->campos_busqueda,"Notificacion");
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"ENTRADA");
		array_push($this->campos_especiales,"SALIDA");
        array_push($this->campos_especiales,"ORDEN");
        array_push($this->campos_especiales,"ENVIO");
        array_push($this->campos_especiales,"RECEPCION");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Notificacion");		 	 
	 }
	 // --------------------------------------------------------
