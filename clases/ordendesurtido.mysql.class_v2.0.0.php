...
class cltbl_OrdenDeSurtido_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ordendesurtido";
     private $NombreDeLaVista = "tbl_ordendesurtido_view";
     private $NombreCampoLlave ="nIDOrdenDeSurtido";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"Comentarios");	 
        ...
        array_push($this->campos_obligatorios_leyendas,"Comentarios");			 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Nombre");
		array_push($this->campos_listado,"Comentarios");
