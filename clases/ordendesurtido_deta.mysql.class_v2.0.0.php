<?php
// ----------------------------------------------------------------------------------
// ordendesurtido_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_OrdenDeSurtido_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ordendesurtido_deta";
     private $NombreDeLaVista = "tbl_ordendesurtido_deta_view";
     private $NombreCampoLlave ="nIDOrdenDeSurtido_Deta";
	 private $NombreCampoOrdenamiento="nIDOrdenDeSurtido_Deta";
	 private $NombreCampoParaNoRepetir="nIDOrdenDeSurtido_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_norepetir,"nIDOrdenDeSurtido_Deta");  
