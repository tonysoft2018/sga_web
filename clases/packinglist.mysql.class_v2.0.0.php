...
class cltbl_Packinglist_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_packinglist";
     private $NombreDeLaVista = "tbl_packinglist_view";
     private $NombreCampoLlave ="nIDPackingList";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Archivo");
		array_push($this->campos_obligatorios,"nIDUsuario");	
		array_push($this->campos_obligatorios,"nIDProveedor");
		array_push($this->campos_obligatorios,"nIDComprador");
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre del Archivo");  
		array_push($this->campos_obligatorios_leyendas,"Realizo");	
		array_push($this->campos_obligatorios_leyendas,"Proveedor");	
		array_push($this->campos_obligatorios_leyendas,"Comprador");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		unset($this->campos_listado_entradasxcompras);

		$this->campos_listado=array();
		$this->campos_listado_importacion=array();
		$this->campos_listado_entradasxcompras=array();
		
		
		array_push($this->campos_listado,"Fecha");
		array_push($this->campos_listado,"Folio");
        array_push($this->campos_listado,"Archivo");
		array_push($this->campos_listado,"Realizo");
		array_push($this->campos_listado,"Proveedor");
		array_push($this->campos_listado,"Comprador");
		array_push($this->campos_listado,"Estatus");
		array_push($this->campos_listado,"FechaImportacion");
		...
		array_push($this->campos_listado_entradasxcompras,"Fecha");
		array_push($this->campos_listado_entradasxcompras,"Folio");
        array_push($this->campos_listado_entradasxcompras,"FechaImportacion");
		array_push($this->campos_listado_entradasxcompras,"Usuario Creacion");		 
		array_push($this->campos_listado_entradasxcompras,$this->NombreCampoLlave);
