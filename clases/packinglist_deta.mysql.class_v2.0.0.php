<?php
// ----------------------------------------------------------------------------------
// ambiente_clasificaciones_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_PackingList_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_packinglist_deta";
     private $NombreDeLaVista = "tbl_packinglist_deta_view";
     private $NombreCampoLlave ="nIDPackingList_Deta";
	 private $NombreCampoOrdenamiento="nIDPackingList_Deta";
	 private $NombreCampoParaNoRepetir="nIDPackingList_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDPackingList");
		...
		array_push($this->campos_norepetir,"nIDPackingList_Deta");  		 
	...
	private function ActualizarLeidos_Barras($l_nID, $l_Cantidad, $l_Observaciones){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtInsercion = "UPDATE " .  $this->NombreDeLaTabla;
		$txtInsercion = $txtInsercion . " SET ";
		$txtInsercion = $txtInsercion . " Leidos_Barras=" . $l_Cantidad . ",";
	...
	public function CambiarLeidos_Barras($l_nID, $l_Cantidad, $l_Observaciones ){
		if($this->bandTieneAlgunError){
		   return FALSE;
		}
		...
		if ($this->ActualizarLeidos_Barras($l_nID,$l_Cantidad,$l_Observaciones)==TRUE){
			return TRUE;
		} else {
			return FALSE;
		}
