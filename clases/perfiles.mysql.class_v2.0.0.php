...
class cltbl_Perfiles_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_perfiles";
     private $NombreDeLaVista = "tbl_perfiles_view";
     private $NombreCampoLlave ="nIDPerfil";
	 private $NombreCampoOrdenamiento="Perfil";
	 private $NombreCampoParaNoRepetir="Perfil";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Perfil");		 
		...
		array_push($this->campos_obligatorios_leyendas,"Nombre del Perfil"); 
		array_push($this->campos_obligatorios_leyendas,"Clasificacion");	
		...
		array_push($this->campos_norepetir,"Perfil");  
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"TodosLosCentrosDeServicio");	
		array_push($this->campos_listado,"CentroDeServicio");	
		array_push($this->campos_listado,"TodosLosAlmacenes");
		array_push($this->campos_listado,"Almacen");
		array_push($this->campos_listado,"Clasificacion");			 		 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Clasificacion");	
	 ...
	 public function Cargar_Campos_Especiales(){	 
		...
		array_push($this->campos_especiales,"TodosLosAlmacenes");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Perfil");		 	 
	 }
	 // --------------------------------------------------------
