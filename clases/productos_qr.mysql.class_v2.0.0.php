...
class cltbl_Cat_Productos_QR_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_productos_qr";
     private $NombreDeLaVista = "tbl_productos_qr";
     private $NombreCampoLlave ="nIDProducto_Qr";
	 private $NombreCampoOrdenamiento="nIDProducto_Qr";
	 private $NombreCampoParaNoRepetir="CodigoQR";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios_leyendas,"CodigoQR"); 		 
		...
		array_push($this->campos_norepetir,"CodigoQR");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado_importacion,"CodigoQR");		 
