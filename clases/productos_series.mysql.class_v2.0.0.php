...
class cltbl_Cat_Productos_Series_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_cat_productos_series";
     private $NombreDeLaVista = "tbl_cat_productos_series";
     private $NombreCampoLlave ="nIDProducto_Serie";
	 private $NombreCampoOrdenamiento="nIDProducto_Serie";
	 private $NombreCampoParaNoRepetir="Serie";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Serie");		 
		...
		array_push($this->campos_obligatorios_leyendas,"Serie"); 		 
		...
		array_push($this->campos_norepetir,"Serie");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Serie");		 
		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"Serie");		 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Serie");		 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Serie");		 	 	 
	 }
	 // --------------------------------------------------------
	...
	public function ContarRegistros($condicion){
	 ...
	 private function ActualizarLeido($l_nID, $l_Leido, $l_Observaciones){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtInsercion = "UPDATE " .  $this->NombreDeLaTabla;
		$txtInsercion = $txtInsercion . " SET ";
		$txtInsercion = $txtInsercion . " Leido='" . $l_Leido . "',";
	 ...
	 public function CambiarLeido($l_nID, $l_Leido, $l_Observaciones){
		if($this->bandTieneAlgunError){
		   return FALSE;
		}
		...
		if ($this->ActualizarLeido($l_nID, $l_Leido, $l_Observaciones)==TRUE){
			return TRUE;
		} else {
			return FALSE;
		}
