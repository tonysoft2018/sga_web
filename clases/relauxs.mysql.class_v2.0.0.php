...
class cltbl_RelaUxS_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_relauxs";
     private $NombreDeLaVista = "tbl_relauxs_view";
     private $NombreCampoLlave ="nIDRelaUxS";
	 private $NombreCampoOrdenamiento="nIDUsuario";
	 private $NombreCampoParaNoRepetir="nIDRelaUxS";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDSesion");
        ...
        array_push($this->campos_obligatorios_rango2,10000);  		 
        ...
        array_push($this->campos_obligatorios_leyendas,"ID Usuario"); 
        array_push($this->campos_obligatorios_leyendas,"ID Sesion"); 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"IDSesion");	
		array_push($this->campos_listado,"FechaCreacion");			 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"IDSesion");
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"IDSesion");
	 }
	 // --------------------------------------------------------
