...
class cltbl_SalidasPorOtrosConceptos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_salidaporotrosconceptos";
     private $NombreDeLaVista = "tbl_salidaporotrosconceptos_view";
     private $NombreCampoLlave ="nIDSalidaPorOtrosConceptos";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"nIDCat_ConceptoSalida");	
		...
		array_push($this->campos_obligatorios_leyendas,"Concepto de Salida");	
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"ConceptoSalida");
	 ...
	 public function Cargar_Campos_Combo(){	 
        ...
        array_push($this->campos_combo,"ConceptoSalida");
	 }
	 // --------------------------------------------------------
