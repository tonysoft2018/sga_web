<?php
// ----------------------------------------------------------------------------------
// salidasporotrosconceptos_deta.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_SalidasPorOtrosConceptos_Deta_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_salidaporotrosconceptos_deta";
     private $NombreDeLaVista = "tbl_salidaporotrosconceptos_deta_view";
     private $NombreCampoLlave ="nIDSalidaPorOtrosConceptos_Deta";
	 private $NombreCampoOrdenamiento="nIDSalidaPorOtrosConceptos_Deta";
	 private $NombreCampoParaNoRepetir="nIDSalidaPorOtrosConceptos_Deta";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"nIDSalidaPorOtrosConceptos");
        ...
        array_push($this->campos_obligatorios_tipo,"Codigo"); // CADENA/NUMERO/DECIMAL/FECHA
        array_push($this->campos_obligatorios_tipo,"NUMERO"); // CADENA/NUMERO/DECIMAL/FECHA
        ...
        array_push($this->campos_obligatorios_leyendas,"No tiene Codigo del Producto");
		...
		array_push($this->campos_norepetir,"nIDSalidaPorOtrosConceptos_Deta");  		 
