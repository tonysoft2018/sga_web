...
class cltbl_Sesion_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_sesion";
     private $NombreDeLaVista = "tbl_sesion";
     private $NombreCampoLlave ="nIDSesion";
	 private $NombreCampoOrdenamiento="FechaCreacion";
	 private $NombreCampoParaNoRepetir="IDSesion";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"IDSesion");
		...
		array_push($this->campos_obligatorios_leyendas,"IDSesion"); 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Navegador");	
		array_push($this->campos_listado,"GUID");			 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Navegador");	
		array_push($this->campos_busqueda,"GUID");	
