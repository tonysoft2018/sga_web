<?php
// ----------------------------------------------------------------------------------
// salidasporotrosconceptos.mysql.class.php
// ----------------------------------------------------------------------------------
...
class cltbl_Traspasos_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_traspasos";
     private $NombreDeLaVista = "tbl_traspasos_view";
     private $NombreCampoLlave ="nIDTraspaso";
	 private $NombreCampoOrdenamiento="Folio";
	 private $NombreCampoParaNoRepetir="Folio";
	 private $TipoDatoCampoParaNoRepetir="NUMERO"; //CADENA,FECHA,NUMERO
	 ...
	 public $campos_norepetir=array();
	 public $campos_norepetir_tipo=array();
	 public $campos_listado=array();
	 public $campos_listado_importacion=array();
     public $campos_listado_entradasxcompras=array();
     public $campos_listado_ordenesdesurtido=array();
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
        ...
        array_push($this->campos_obligatorios,"Folio");
        array_push($this->campos_obligatorios,"Entrega");
        array_push($this->campos_obligatorios,"DatosDelVehiculo");
		array_push($this->campos_obligatorios,"nIDCat_Almacen_Origen");
        array_push($this->campos_obligatorios,"nIDCat_Almacen_Destino");	
        array_push($this->campos_obligatorios,"Recibe");	
        array_push($this->campos_obligatorios,"nIDCat_MotivosTraspaso");	
        array_push($this->campos_obligatorios,"nIDOrdenDeSurtido");	
        array_push($this->campos_obligatorios,"nIDUsuario");	 
		
		//** TIPOS */
		unset($this->campos_obligatorios_tipo);
		$this->campos_obligatorios_tipo=array();
        array_push($this->campos_obligatorios_tipo,"NUMERO"); // CADENA/NUMERO/FECHA
        ...
        array_push($this->campos_obligatorios_rango1,0); 
        ...
        array_push($this->campos_obligatorios_comparativa1,"MAYOR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADOCON
        ...
        array_push($this->campos_obligatorios_rango2,1000000); 
        ...
        array_push($this->campos_obligatorios_comparativa2,"MENORIGUAL");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON
        ...
        array_push($this->campos_obligatorios_leyendas,"Folio");  
        array_push($this->campos_obligatorios_leyendas,"Entrega");  
        array_push($this->campos_obligatorios_leyendas,"DatosDelVehiculo");  
		array_push($this->campos_obligatorios_leyendas,"Almacen Origen");  
        array_push($this->campos_obligatorios_leyendas,"Almacen Destino");	
        array_push($this->campos_obligatorios_leyendas,"Recibe");  
        array_push($this->campos_obligatorios_leyendas,"Motivo de Traspaso");
        array_push($this->campos_obligatorios_leyendas,"Orden de Surtido");				
        array_push($this->campos_obligatorios_leyendas,"Usuario");		         		 
        ...
        array_push($this->campos_obligatorios_mostrarleyenda,"SI");	
        array_push($this->campos_obligatorios_mostrarleyenda,"SI");	
        array_push($this->campos_obligatorios_mostrarleyenda,"SI");	
        array_push($this->campos_obligatorios_mostrarleyenda,"SI");	
        array_push($this->campos_obligatorios_mostrarleyenda,"SI");	
        ...
        array_push($this->campos_obligatorios_valorescomparar1,"");	
        array_push($this->campos_obligatorios_valorescomparar1,"");	
        array_push($this->campos_obligatorios_valorescomparar1,"");	
        array_push($this->campos_obligatorios_valorescomparar1,"");	
        ...
        array_push($this->campos_obligatorios_valorescomparar2,"");	
        array_push($this->campos_obligatorios_valorescomparar2,"");		
        array_push($this->campos_obligatorios_valorescomparar2,"");		
		array_push($this->campos_obligatorios_valorescomparar2,"");		
		
		// Campos no repetir
		unset($this->campos_norepetir);
		$this->campos_norepetir=array();			 
		array_push($this->campos_norepetir,"Folio");  		 

		unset($this->campos_norepetir_tipo);
		$this->campos_norepetir_tipo=array();			 
		array_push($this->campos_norepetir_tipo,"NUMERO");   // CADENA/NUMERO/FECHA		 
	 }

	 public function Cargar_Campos_Listado(){	 
		unset($this->campos_listado);
		unset($this->campos_listado_importacion);    
        unset($this->campos_listado_ordenesdesurtido);

		$this->campos_listado=array();
		$this->campos_listado_importacion=array();
		$this->campos_listado_ordenesdesurtido=array();
		
		
		array_push($this->campos_listado,"Folio");
		array_push($this->campos_listado,"Fecha");
		
        array_push($this->campos_listado,"Entrega");
        array_push($this->campos_listado,"DatosDelVehiculo");
        array_push($this->campos_listado,"Almacen_Origen");
		array_push($this->campos_listado,"Almacen_Destino");
		array_push($this->campos_listado,"Recibe");
		array_push($this->campos_listado,"Motivo");	
		array_push($this->campos_listado,"OrdenDeSurtido_Folio");	
		array_push($this->campos_listado,"Tipo"); 
		array_push($this->campos_listado,"Estatus"); 
		array_push($this->campos_listado,$this->NombreCampoLlave);
		
		array_push($this->campos_listado_importacion,"Archivo");	 
        array_push($this->campos_listado_importacion,$this->NombreCampoLlave);	  
        
        array_push($this->campos_listado_ordenesdesurtido,"OrdenDeSurtido_Folio");	 
        array_push($this->campos_listado_ordenesdesurtido,"OrdenDeSurtido_Fecha");	 
        array_push($this->campos_listado_ordenesdesurtido,"Estatus");	 
		array_push($this->campos_listado_ordenesdesurtido,$this->NombreCampoLlave);	  
	 }
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Folio");
		array_push($this->campos_busqueda,"OrdenDeSurtido_Folio");  
        	 	 

		unset($this->campos_busqueda_tipo);
		$this->campos_busqueda_tipo=array();
		
		array_push($this->campos_busqueda_tipo,"NUMERO"); // CADENA/NUMERO/FECHA
		array_push($this->campos_busqueda_tipo,"NUMERO"); // CADENA/NUMERO/FECHA
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		array_push($this->campos_combo,"Folio");		 	 
        array_push($this->campos_combo,"Almacen_Origen");		 	 
        array_push($this->campos_combo,"Almacen_Destino");         
	 }
	 // --------------------------------------------------------
	...
	public function ContarRegistros($condicion){
	 ...
	 private function Consultar_Id($condicion){
		...
		if($res){
			...
			while($registro=mysqli_fetch_array($res, MYSQLI_ASSOC)){	
				...
				$l_Valor=$registro[$this->NombreCampoLlave];
			    break;			  			 
			}  
	 ...
	 // FOLIACION
	 // -------------------------------
	 private function Consultar_Folio($l_Folio){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtConsulta="";
		$txtConsulta = "SELECT Folio";
		$txtConsulta = $txtConsulta . " FROM ";
		$txtConsulta = $txtConsulta . $this->NombreDeLaVista;
		$txtConsulta = $txtConsulta . " WHERE ";
		$txtConsulta = $txtConsulta . "Folio=" .$l_Folio;
	...
	private function ConsultarSiguienteFolio(){
		...
		$txtConsulta="";
		$txtConsulta = "SELECT Max(Folio) as Folio";
		$txtConsulta = $txtConsulta . " FROM ";
		$txtConsulta = $txtConsulta . $this->NombreDeLaVista;
		...
		if($res){
			if($registro=mysqli_fetch_array($res, MYSQLI_ASSOC)){
			   ...
			   if($registro["Folio"]!=NULL){
					$SiguienteFolio=$registro["Folio"];
			   }

			   $SiguienteFolio=$SiguienteFolio+1;
			   while(1){
					if($this->VerificaSiExisteElFolio($SiguienteFolio)==TRUE){
						 $SiguienteFolio=$SiguienteFolio+1;
					} else {
						break;
					}
	...
	public function VerificaSiExisteElFolio($l_Folio){
		 if($this->Consultar_Folio($l_Folio)==TRUE){
		  return TRUE;
		} else {
		  return FALSE;
		}
    ...
    // -------------------------------
	 ...
	 private function ActualizarEstatus($l_nID, $l_Estatus, $l_Observaciones){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtInsercion = "UPDATE " .  $this->NombreDeLaTabla;
		$txtInsercion = $txtInsercion . " SET ";
		$txtInsercion = $txtInsercion . " Estatus='" . $l_Estatus . "',";
		             ...
		             for($j=1;$j<$numCampos;$j=$j+1){	
						 ...
						 switch($this->tipos[$j]){
							...
							case "FECHA":  if( $this->estructura[$j]=="FechaModificacion" ){
										   ...
										   break;
							case "NUMERO": if( $this->estructura[$j]!="bEstado" && $this->estructura[$j]!="Folio"  ){
	 ...
	 public function CambiarEstatus($l_nID, $l_Estatus, $l_Observaciones ){
		if($this->bandTieneAlgunError){
		   return FALSE;
		}
		...
		if ($this->ActualizarEstatus($l_nID,$l_Estatus,$l_Observaciones)==TRUE){
			return TRUE;
		} else {
			return FALSE;
		}
	...
	public function getSiguienteFolio(){
		...
		return $this->ConsultarSiguienteFolio();    
	 }
	...
	public function get_Id($consulta){
        ...
        return $this->Consultar_Id($consulta);   
	}
