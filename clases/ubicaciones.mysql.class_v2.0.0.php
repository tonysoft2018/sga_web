...
class cltbl_Ubicaciones_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_ubicaciones";
     private $NombreDeLaVista = "tbl_ubicaciones_view";
     private $NombreCampoLlave ="nIDUbicacion";
	 private $NombreCampoOrdenamiento="nIDUbicacion";
	 private $NombreCampoParaNoRepetir="nIDUbicacion";
	 ...
	 public function setInformacion_Grabar($registro) {
		...
		if($this->contCampos<=0){
			...
			$this->bandTieneAlgunError=TRUE;
            $this->ErrorActual="No tiene una SCHEMA cargado";     
            echo "ERROR NO TIENE ESQUEMA";  
		    return FALSE;
        }
    
		for($i=0;$i<$this->contCampos;$i=$i+1){					 
            $this->dtGrabar[$this->contNumDatos][$this->estructura[$i]]=$registro[$i];		
            //echo "CARGAR:" 	. $this->dtGrabar[$this->contNumDatos][$this->estructura[$i]]; 
		}
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"nIDCat_Matriz");
        array_push($this->campos_obligatorios,"Codigo");	
        array_push($this->campos_obligatorios,"CodigoQR");	
        ...
        array_push($this->campos_obligatorios_comparativa1,"SIN COMPARAR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON	
        array_push($this->campos_obligatorios_comparativa1,"SIN COMPARAR");   // SIN COMPARAR, IGUAL, MAYOR, MENOR, MAYORIGUAL, MENORIGUAL, COMPARADO CON	
		...
		array_push($this->campos_obligatorios_leyendas,"ID de la matriz"); 
        array_push($this->campos_obligatorios_leyendas,"Codigo del Producto");
        array_push($this->campos_obligatorios_leyendas,"CodigoQR del producto");
		...
		array_push($this->campos_norepetir,"nIDUbicacion");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Almacen");
        array_push($this->campos_listado,"RazonSocial");		
        array_push($this->campos_listado,"Pasillo");		 
        array_push($this->campos_listado,"Rack");		 
        array_push($this->campos_listado,"Columna");		 
        array_push($this->campos_listado,"Nivel");		 
        array_push($this->campos_listado,"SubNivel");		 
        array_push($this->campos_listado,"Codigo");		 
        array_push($this->campos_listado,"CodigoQR");		 
        array_push($this->campos_listado,"Producto");		 


		array_push($this->campos_listado,$this->NombreCampoLlave);	 

		array_push($this->campos_listado_importacion,"IDConceptoSalida");
		array_push($this->campos_listado_importacion,"ConceptoSalida");	
		array_push($this->campos_listado_importacion,"Descripcion");		 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Codigo");
        array_push($this->campos_busqueda,"CodigoQR");			 
        array_push($this->campos_listado,"Producto");		 
        array_push($this->campos_listado,"Almacen");	
        array_push($this->campos_listado,"RazonSocial");	 
        array_push($this->campos_listado,"Pasillo");
		...
		array_push($this->campos_busqueda_tipo,"CADENA"); // CADENA/NUMERO/FECHA
	 ...
	 public function Cargar_Campos_Combo(){	 
        ...
        array_push($this->campos_combo,"Codigo");
        array_push($this->campos_combo,"CodigoQR");		 	 
        array_push($this->campos_combo,"Producto");
        array_push($this->campos_combo,"Almacen");
        array_push($this->campos_combo,"RazonSocial");
        array_push($this->campos_combo,"Pasillo");
	 }
	 // --------------------------------------------------------
	...
	public function ContarRegistros($condicion){
	 ...
	 public function CargarCampos($l_Tipos){
       // Abrea la conexion                         
	   $mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
	   ...
	   if($res){
            ...
            if($l_Tipos=="GRABAR"){
                $this->contCampos=0;
                $this->estructura[$this->contCampos]="nIDUbicacion";
                $this->tipos[$this->contCampos]="NUMERO";
                $this->contCampos=$this->contCampos+1;                   
    
                $this->estructura[$this->contCampos]="nIDCat_Matriz";
                $this->tipos[$this->contCampos]="NUMERO";
                $this->contCampos=$this->contCampos+1;   
                
                $this->estructura[$this->contCampos]="nIDProducto";
                $this->tipos[$this->contCampos]="NUMERO";
                $this->contCampos=$this->contCampos+1;   

                $this->estructura[$this->contCampos]="Codigo";
                $this->tipos[$this->contCampos]="CADENA";
                $this->contCampos=$this->contCampos+1; 
                
                $this->estructura[$this->contCampos]="CodigoQR";
                $this->tipos[$this->contCampos]="CADENA";
                $this->contCampos=$this->contCampos+1;   

                $this->estructura[$this->contCampos]="AreaInspeccion";
                $this->tipos[$this->contCampos]="CADENA";
                $this->contCampos=$this->contCampos+1; 
                
                $this->estructura[$this->contCampos]="FechaModificacion";
                $this->tipos[$this->contCampos]="FECHA";
                $this->contCampos=$this->contCampos+1;
                
                $this->estructura[$this->contCampos]="FechaCreacion";
                $this->tipos[$this->contCampos]="FECHA";
                $this->contCampos=$this->contCampos+1;
                
                $this->estructura[$this->contCampos]="Observaciones";
                $this->tipos[$this->contCampos]="CADENA";
                $this->contCampos=$this->contCampos+1; 
                
                $this->estructura[$this->contCampos]="bEstado";
                $this->tipos[$this->contCampos]="NUMERO";
                $this->contCampos=$this->contCampos+1;   
              
                $this->estructura[$this->contCampos]="Crear";
                $this->tipos[$this->contCampos]="NUMERO";
                $this->contCampos=$this->contCampos+1;   

                $this->estructura[$this->contCampos]="Cambiar";	
                $this->tipos[$this->contCampos]="NUMERO";	
                $this->contCampos=$this->contCampos+1;   

                $this->estructura[$this->contCampos]="Eliminar";	
                $this->tipos[$this->contCampos]="NUMERO";	
                $this->contCampos=$this->contCampos+1;                    
	 ...
	 private function ActualizarExistencias($l_nID, $l_Cantidad, $l_Observaciones){
		// Abrea la conexion
		$mysqli=mysqli_connect($this->servidor,$this->usuario,$this->password,$this->basededatos);
		...
		$txtInsercion = "UPDATE " .  $this->NombreDeLaTabla;
		$txtInsercion = $txtInsercion . " SET ";
		$txtInsercion = $txtInsercion . " Cantidad=" . $l_Cantidad . ",";
	 ...
	 public function CambiarExistencias($l_nID, $l_Existencia, $l_Observaciones){
		if($this->bandTieneAlgunError){
		   return FALSE;
		}
		...
		if ($this->ActualizarExistencias($l_nID,$l_Existencia,$l_Observaciones)==TRUE){
			return TRUE;
		} else {
			return FALSE;
		}
