...
class cltbl_Usuarios_v2_0_0
{
	 ...
	 // Base de datos
	 private $NombreDeLaTabla = "tbl_usuarios";
     private $NombreDeLaVista = "tbl_usuarios_view";
     private $NombreCampoLlave ="nIDUsuario";
	 private $NombreCampoOrdenamiento="Nombre";
	 private $NombreCampoParaNoRepetir="Usuario";
	 ...
	 public function Cargar_Campos_Obligatorios(){	 
		...
		array_push($this->campos_obligatorios,"Nombre");		 
		array_push($this->campos_obligatorios,"nIDPerfil");		 		 
		...
		array_push($this->campos_obligatorios_leyendas,"Password");	
		array_push($this->campos_obligatorios_leyendas,"Nombre del Usuario");		
		array_push($this->campos_obligatorios_leyendas,"Perfil");	
		...
		array_push($this->campos_norepetir,"Usuario");  		 
	 ...
	 public function Cargar_Campos_Listado(){	 
		...
		array_push($this->campos_listado,"Usuario");
		array_push($this->campos_listado,"Nombre");	
		array_push($this->campos_listado,"Perfil");			 
	 ...
	 public function Cargar_Campos_Busqueda(){	 
		...
		array_push($this->campos_busqueda,"Usuario");
		array_push($this->campos_busqueda,"Clave");	
		array_push($this->campos_busqueda,"Nombre");	
		array_push($this->campos_busqueda,"Direccion");	
		array_push($this->campos_busqueda,"Telefono");	
		array_push($this->campos_busqueda,"Celular");	
		array_push($this->campos_busqueda,"Email");		
		array_push($this->campos_busqueda,"Perfil");			 	 
	 ...
	 public function Cargar_Campos_Combo(){	 
		...
		//array_push($this->campos_combo,"Usuario");	
		array_push($this->campos_combo,"Nombre");		 	 
	 }
	 // --------------------------------------------------------
