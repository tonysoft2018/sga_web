...
<body>
     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                ...
                <div class="col-md-8">	       	                                     
                        <textarea class="form-control" rows="5" name="Descripcion" id="txt_Descripcion" style='height: 100px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '<?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>   </textarea>        
                </div>
 ...
 ?>
         <script>
             ...
             //obVerificar=setTimeout(fn_Consultar_Detalles_Clic('<?php echo $l_Condicion ?>'),3000);
         </script>
 <?php
     }    
?>           
