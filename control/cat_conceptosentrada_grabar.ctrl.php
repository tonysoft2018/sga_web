<?php
// ----------------------------------------------------------------------------------
// cat_conceptosentrada_grabar.php
// ----------------------------------------------------------------------------------
    ...
    if($l_Linea>0){
       ...
       for($i=0;$i<strlen($l_Cadena);$i++){
           ...
           if($l_Valor=="," || $l_Valor==";"){
              ...
              switch($l_Columna){
                 case 0:$l_IDConcepto=$l_IDConcepto . $l_Valor;
                        break;
                 case 1:$l_ConceptoEntrada=$l_ConceptoEntrada . $l_Valor;
                        break;
        ...
        $datos_leidos=$datos_leidos + ["idconceptoentrada"=>$l_IDConcepto];
        $datos_leidos=$datos_leidos + ["conceptoentrada"=>$l_ConceptoEntrada];
    ...
    for ($row = 2; $row <= $highestRow; $row++){ 
       ...
       $l_Descripcion="";          
        ...
        if($sheet->getCell("A".$row)->getValue()!=null){
            $l_IDConcepto=$sheet->getCell("A".$row)->getValue();
        }

        if($sheet->getCell("B".$row)->getValue()!=null){
            $l_ConceptoEntrada=$sheet->getCell("B".$row)->getValue();
        } 
        ...
        if(strlen($l_IDConcepto)>0 ){
            if(strlen($l_ConceptoEntrada)>0){
