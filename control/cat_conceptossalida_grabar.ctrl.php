<?php
// ----------------------------------------------------------------------------------
// cat_conceptossalida_grabar.php
// ----------------------------------------------------------------------------------
    ...
    if($l_Linea>0){
       ...
       for($i=0;$i<strlen($l_Cadena);$i++){
           ...
           if($l_Valor=="," || $l_Valor==";"){
              ...
              switch($l_Columna){
                 case 0:$l_IDConceptoSalida=$l_IDConceptoSalida . $l_Valor;
                        break;
                 case 1:$l_ConceptoSalida=$l_ConceptoSalida . $l_Valor;
                        break;
        ...
        $datos_leidos=$datos_leidos + ["idconceptosalida"=>$l_IDConceptoSalida];
        $datos_leidos=$datos_leidos + ["conceptosalida"=>$l_ConceptoSalida];
        ...
        // Regresar              
        $datos=$datos + ["idconcepto"=>$l_IDConcepto];
        $datos=$datos + ["conceptoentrada"=>$l_ConceptoEntrada];
    ...
    for ($row = 2; $row <= $highestRow; $row++){ 
       ...
       $l_Descripcion="";       
        ...
        if($sheet->getCell("A".$row)->getValue()!=null){
            $l_IDConceptoSalida=$sheet->getCell("A".$row)->getValue();
        }

        if($sheet->getCell("B".$row)->getValue()!=null){
            $l_ConceptoSalida=$sheet->getCell("B".$row)->getValue();
        } 
        ...
        if(strlen($l_IDConceptoSalida)>0 ){
            if(strlen($l_ConceptoSalida)>0){
        ...
        // ------------------------------------------------------------------------- 
                ...
                // Regresar              
                $datos=$datos + ["idconceptosalida"=>$l_IDConceptoSalida];
                $datos=$datos + ["conceptosalida"=>$l_ConceptoSalida];
                $datos=$datos + ["descripcion"=>$l_Descripcion];
