    ...
    if($l_Linea>0){
       ...
       for($i=0;$i<strlen($l_Cadena);$i++){
           ...
           if($l_Valor=="," || $l_Valor==";"){
              ...
              switch($l_Columna){
                 case 0:$l_IDEstado=$l_IDEstado . $l_Valor;
                        break;
                 case 1:$l_Estado=$l_Estado . $l_Valor;
                        break;
        ...
        $datos_leidos=$datos_leidos + ["idestado"=>$l_IDEstado];
        ...
        // Regresar              
        $datos=$datos + ["idestado"=>$l_IDEstado];
    ...
    for ($row = 2; $row <= $highestRow; $row++){ 
       ...
       $l_Descripcion="";         
        ...
        if($sheet->getCell("A".$row)->getValue()!=null){
            $l_IDEstado=$sheet->getCell("A".$row)->getValue();
        }

        if($sheet->getCell("B".$row)->getValue()!=null){
            $l_Estado=$sheet->getCell("B".$row)->getValue();
        } 
