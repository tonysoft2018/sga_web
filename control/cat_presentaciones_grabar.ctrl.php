    ...
    if($l_Linea>0){
       ...
       for($i=0;$i<strlen($l_Cadena);$i++){
           ...
           if($l_Valor=="," || $l_Valor==";"){
              ...
              switch($l_Columna){
                 case 0:$l_IDPresentacion=$l_IDPresentacion . $l_Valor;
                        break;
                 case 1:$l_Presentacion=$l_Presentacion . $l_Valor;
                        break;
        ...
        $datos_leidos=$datos_leidos + ["idpresentacion"=>$l_IDPresentacion];
        $datos_leidos=$datos_leidos + ["presentacion"=>$l_Presentacion];
        ...
        // Regresar        
        $datos=$datos + ["idpresentacion"=>$l_IDPresentacion];
    ...
    for ($row = 2; $row <= $highestRow; $row++){ 
       ...
       $l_Descripcion="";
        ...
        if($sheet->getCell("A".$row)->getValue()!=null){
            $l_IDPresentacion=$sheet->getCell("A".$row)->getValue();
        }

        if($sheet->getCell("B".$row)->getValue()!=null){
            $l_Presentacion=$sheet->getCell("B".$row)->getValue();
        } 
