<?php
// ----------------------------------------------------------------------------------
// cat_unidadesdemedida_grabar.php
// ----------------------------------------------------------------------------------
    ...
    if($l_Linea>0){
       ...
       for($i=0;$i<strlen($l_Cadena);$i++){
           ...
           if($l_Valor=="," || $l_Valor==";"){
              ...
              switch($l_Columna){
                 case 0:$l_UnidadDeMedida=$l_UnidadDeMedida . $l_Valor;
                        break;
        ...
        $datos_leidos=$datos_leidos + ["unidaddemedida"=>$l_UnidadDeMedida];
    ...
    for ($row = 2; $row <= $highestRow; $row++){ 
       ...
       $l_Descripcion="";
        ...
        if($sheet->getCell("A".$row)->getValue()!=null){
            $l_UnidadDeMedida=$sheet->getCell("A".$row)->getValue();
        }
 
        if($sheet->getCell("B".$row)->getValue()!=null){
            $l_Descripcion=$sheet->getCell("B".$row)->getValue();
        }
