<?php
// ----------------------------------------------------------------------------------
// entradasxcompras_consultar.php
// ----------------------------------------------------------------------------------
...
for($i=0;$i<$l_NumeroDeRegistros;$i++){
    ...
    if($l_Tipo=="directa"){
        ...
        if(strlen($l_Condicion)<=0){   
                ...
                switch($tbl->campos_busqueda_tipo[$h]){
                    case "CADENA":
                        if(strlen($l_Consulta)>0){                        
                            $l_Consulta=$l_Consulta . " or " . $tbl->campos_busqueda[$h] . " like '%" . $l_Condicion . "%'";
                        } else {
                            $l_Consulta=$l_Consulta . $tbl->campos_busqueda[$h] . " like '%" . $l_Condicion . "%'";
                        }                  
                    ...
                    case "NUMERO":
                        ...
                        if(strlen($l_Consulta)>0){                        
                            $l_Consulta=$l_Consulta . " or " . $tbl->campos_busqueda[$h] . "=" . $l_Condicion;
                        } else {
                            $l_Consulta=$l_Consulta . $tbl->campos_busqueda[$h] . "=" . $l_Condicion;
                        }                  

                        break;
                    case "FECHA": 
                    
                        $l_Consulta_Fechas="(" . $tbl->campos_busqueda[$h] . " >='" . $l_Condicion . " 00:00:01' and " . $tbl->campos_busqueda[$h] . "<'" . $l_Condicion . " 23:59:00')";
                        if(strlen($l_Consulta)>0){                        
                            $l_Consulta=$l_Consulta . " or " . $l_Consulta_Fechas;
                        } else {
                            $l_Consulta=$l_Consulta_Fechas;
                        }       
            ...
            if(strlen($l_Consulta)>0){
                $l_Condicion="(" . $l_Consulta . ") and bEstado=0";            
            } else {
                $l_Condicion=$Campo_Llave . ">0 and bEstado=0";
            }                  
        }
