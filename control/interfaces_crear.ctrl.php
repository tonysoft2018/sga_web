...
for($i=0;$i<$l_NumeroDeRegistros;$i++){          
    ...
    // -------------------------------------------------------------------------
    // Valores de un listado
    for($j=0;$j<count($tbl->posicion_compararI);$j++){

        if($tbl->posicion_compararI[$j]>0){
             

            switch($tbl->posicion_compararI[$j]){

                case 1:
                    $Campo_Obligatorio=$tbl->campos_obligatorios[$j];
        
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        $campo=$tbl->estructura[$h];

                        if($campo==$Campo_Obligatorio){

                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_1);$m++){                                 

                                if($tbl->valores_compararI_1[$m]==$datos_grabar[$h]){
                            ...
                            if($bandLocalizado==0){
                                ...
                                $datos=array();
                                $datos=$datos + ["retorno"=>"FALSE"];                                
                                $datos=$datos + ["msg"=>$tbl->campos_obligatorios_leyendas[$j] . ", valor " . $datos_grabar[$h] ." Invalido(a)"];                                
                                array_push($retorno,$datos);    
                                $retorno=json_encode($retorno);	 
                                echo $retorno;    
                                exit(1);        
                ...
                case 2:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_2);$m++){                                 

                                if($tbl->valores_compararI_2[$m]==$datos_grabar[$h]){
                ...
                case 3:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_3);$m++){                                 

                                if($tbl->valores_compararI_3[$m]==$datos_grabar[$h]){
                ...
                case 4:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_4);$m++){                                 

                                if($tbl->valores_compararI_4[$m]==$datos_grabar[$h]){
                ...
                case 5:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_5);$m++){                                 

                                if($tbl->valores_compararI_5[$m]==$datos_grabar[$h]){
                ...
                case 6:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_6);$m++){                                 

                                if($tbl->valores_compararI_6[$m]==$datos_grabar[$h]){
                ...
                case 7:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_7);$m++){                                 

                                if($tbl->valores_compararI_7[$m]==$datos_grabar[$h]){
                ...
                case 8:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_8);$m++){                                 

                                if($tbl->valores_compararI_8[$m]==$datos_grabar[$h]){
                ...
                case 9:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_9);$m++){                                 

                                if($tbl->valores_compararI_9[$m]==$datos_grabar[$h]){
                ...
                case 10:
                    ...
                    for($h=0;$h<$tbl->get_NumCampos();$h++){
                        ...
                        if($campo==$Campo_Obligatorio){
                            ...
                            $bandLocalizado=0;
                            for($m=0;$m<count($tbl->valores_compararI_10);$m++){                                 

                                if($tbl->valores_compararI_10[$m]==$datos_grabar[$h]){
    ...
    if(strlen($l_Condicion)>0){
        ...
        if($tbl->CualEsElNumeroDeRegistrosCargados()>0){     
            $datos=array();
            $datos=$datos + ["retorno"=>"FALSE"];
            $datos=$datos + ["msg"=>"REGISTRO EXISTENTE"];
            array_push($retorno,$datos);    
            $retorno=json_encode($retorno);	 
            echo $retorno;    
            exit(1);
