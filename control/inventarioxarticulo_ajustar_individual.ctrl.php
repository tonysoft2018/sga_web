<?php
// ----------------------------------------------------------------------------------
// inventarioxarticulo_ajustar_individual.ctrl.php
// ----------------------------------------------------------------------------------
...
for($i=0;$i<$l_NumeroDeRegistros;$i++){          
    ...
    $l_Descripcion=$arreglos[$i]->{"descripcion"};
    $l_Funcion=$arreglos[$i]->{"funcion"};
    ...
    // Basicos 
     ...
     $l_Condicion="nIDIxA=" . $l_nIDIxA . " and bEstado=0 and nIDProducto=" . $l_nIDProducto;
