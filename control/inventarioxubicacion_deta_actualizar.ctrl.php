...
for($i=0;$i<$l_NumeroDeRegistros;$i++){          
    ...
    array_push($datos_grabar,$l_nIDIxU_Deta);
    ...
    if($tbl_Deta->Ejecutar()){
        ...
        $tbl_Enca->CambiarEstatus($l_nIDIxU,"PROCESO", $l_Observaciones);
    }
