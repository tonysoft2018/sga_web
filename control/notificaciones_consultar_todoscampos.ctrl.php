<?php
// ----------------------------------------------------------------------------------
// notificaciones_consultar_todoscampos.ctrl.php
// ----------------------------------------------------------------------------------
...
$l_CampoDeOrdenamiento="";
$l_FormaDeOrdenamiento="";
$l_CantidadRegistros=0;

for($i=0;$i<$l_NumeroDeRegistros;$i++){
    $l_Usuario=$arreglos[$i]->{"usuario"};
    $l_Password=$arreglos[$i]->{"password"};
     
    $l_Condicion="Usuario='" . $l_Usuario . "' and Password='" . $l_Password . "' and Activo='SI' and Web='SI' and bEstado=0";
