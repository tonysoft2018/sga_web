<?php
// ----------------------------------------------------------------------------------
// traspasos_envio_grabar.ctrl.php
// ----------------------------------------------------------------------------------
...
for($i=0;$i<$l_NumeroDeRegistros;$i++){
    ...
    if( $l_nIDCat_MotivosTraspaso<=0 ){
        $datos=array();
        $datos=$datos + ["retorno"=>"FALSE"];
        $datos=$datos + ["msg"=>"NECESITA SELECCIONAR EL MOTIVO DE TRASPASO"];
        array_push($retorno,$datos);    
        $retorno=json_encode($retorno);	 
        echo $retorno;   
        exit(1);  
    ...
    if( strlen($l_Entrega)<=0 ){
        $datos=array();
        $datos=$datos + ["retorno"=>"FALSE"];
        $datos=$datos + ["msg"=>"FALTA CAPTURAR LA PERSONA QUIEN ENTREGA"];
        array_push($retorno,$datos);    
        $retorno=json_encode($retorno);	 
        echo $retorno;   
        exit(1);  
    ...
    if( strlen($l_Recibe)<=0 ){
        $datos=array();
        $datos=$datos + ["retorno"=>"FALSE"];    
        $datos=$datos + ["msg"=>"FALTA CAPTURAR LA PERSONA QUIEN RECIBE"];
        array_push($retorno,$datos);    
        $retorno=json_encode($retorno);	 
        echo $retorno;   
        exit(1);  
    ...
    if( strlen($l_DatosDelVehiculo)<=0 ){
        $datos=array();
        $datos=$datos + ["retorno"=>"FALSE"];
        $datos=$datos + ["msg"=>"FALTA CAPTURAR LOS DATOS DEL VEHICULO"];
        array_push($retorno,$datos);    
        $retorno=json_encode($retorno);	 
        echo $retorno;   
        exit(1);  
