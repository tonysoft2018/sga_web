        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('IDEstado')\">";
                   l_Linea=l_Linea +  "ID";
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Estado')\">";
                   ...
                   for(i=0;i<contador;i++){     
                    ...
                    l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["IDEstado"] + "</label>";
                    l_Linea=l_Linea + "</div>"; 

                    l_Linea=l_Linea + "<div class='col-md-8 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                    l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["Estado"] + "</label>";
                    l_Linea=l_Linea + "</div>";  
