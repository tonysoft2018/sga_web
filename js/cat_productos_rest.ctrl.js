        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Codigo_IZeta')\">";
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Descripcion')\">";
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('UnidadDeMedida')\">";
                   ...
                   for(i=0;i<contador;i++){    
                        ...
                        l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["Codigo_IZeta"] + "</label>";
                        l_Linea=l_Linea + "</div>";  

                        l_Linea=l_Linea + "<div class='col-md-5 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["Descripcion"] + "</label>";
                        l_Linea=l_Linea + "</div>";  

                        l_Linea=l_Linea + "<div class='col-md-2 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["UnidadDeMedida"] + "</label>";
                        l_Linea=l_Linea + "</div>"; 
...
function Consultar_Descripcion(datos){    
    if(datos.length>0){
        $("#modal_espera").modal("show");
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(contador>0){
                    if(obResultado[0]["retorno"]=="TRUE"){ 
                        l_Descripcion=obResultado[0]["descripcion"];
                        l_Puntos=obResultado[0]["puntos"];
                    }  
                }  

                document.getElementById("txt_Descripcion").value=l_Descripcion;    
                document.getElementById("txt_Puntos").value=l_Puntos;         
           }        
        };
