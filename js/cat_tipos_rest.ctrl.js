        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('IDTipo')\">";
                   l_Linea=l_Linea +  "ID";
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Tipo')\">";
                   l_Linea=l_Linea +  "Tipo";
                   l_Linea=l_Linea + "<img src='../iconos/updown.png' style='width: 10px; height: 10px; margin-left:2px;'>";
                   l_Linea=l_Linea + "</label>";
                   l_Linea=l_Linea + "</div>";
                   ...
                   for(i=0;i<contador;i++){     
                    ...
                    l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["IDTipo"] + "</label>";
                    l_Linea=l_Linea + "</div>"; 

                    l_Linea=l_Linea + "<div class='col-md-8 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                    l_Linea=l_Linea + "<label style='cursor:pointer;' >" +   obResultado[i]["Tipo"] + "</label>";
                    l_Linea=l_Linea + "</div>";  
