    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                l_Linea=l_Linea + "<div class='col-md-3  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
                l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
                ...
                l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
                l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
                l_Linea=l_Linea +  "Cantidad/Caja (Pc/Set)";     
                l_Linea=l_Linea + "</label>";
                l_Linea=l_Linea + "</div>";
                ...
                l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
                l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
                l_Linea=l_Linea +  "Peso Bruto (Kgs)";     
                l_Linea=l_Linea + "</label>";
                l_Linea=l_Linea + "</div>";
                ...
                */
                ...
                for(i=0;i<contador;i++){     
                    ...
                    if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        l_Linea=l_Linea + "<label>" +   l_Carton + "</label>";
                        l_Linea=l_Linea + "</div>"; 
                
                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" + l_Codigo + "</label>";
                        l_Linea=l_Linea + "</div>";  
                 
                        l_Linea=l_Linea + "<div class='col-md-3 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" + l_Descripcion + "</label>";
                        l_Linea=l_Linea + "</div>";  
                
                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_Cantidad + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_CantidadCaja + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_Cajas + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_PesoBruto  + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_PesoNeto  + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_TotalM3  + "</label>";
                        l_Linea=l_Linea + "</div>"; 

                        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Linea=l_Linea + "<label>" +  l_Estatus  + "</label>";
                        l_Linea=l_Linea + "</div>"; 
