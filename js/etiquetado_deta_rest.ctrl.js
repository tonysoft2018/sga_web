    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
               l_Linea=l_Linea + "<label style='cursor:pointer;' > Cartón </label>";
               l_Linea=l_Linea + "</div>";    

               l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
               l_Linea=l_Linea + "<label style='cursor:pointer;' > Código</label>";
               l_Linea=l_Linea + "</div>";    
           
               l_Linea=l_Linea + "<div class='col-md-2  w-3 align-bottom align-self-center' style='height: 55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
               l_Linea=l_Linea+"<label style='cursor:pointer;' > Descripción </label>";
               l_Linea=l_Linea+"</div>";
               ...
               for(i=0;i<contador;i++){     
                    l_Registros="";
                    l_Linea=l_Linea + "<div id='id_r" + i +"' class='row align-item-end h-20 align-items-start ' style='font-size:12px;border-bottom: #D9DADA 2px solid;cursor:pointer;font-size:8px;' onmouseover=\"fn_Encima("+i+")\" onmouseout=\"fn_Dejar("+i+")\">";
                    ...
                    if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-family:Arial, Gadget, sans-serif;font-size:12px;' >" +   l_Carton + "</label>";
                        l_Registros=l_Registros + "</div>";    

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_Codigo + "</label>";
                        l_Registros=l_Registros + "</div>";    

                        l_Registros=l_Registros + "<div class='col-md-2 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_Descripcion + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_Cantidad + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_CantidadCaja + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_Cajas + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_PesoBruto + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_PesoNeto + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_TotalM3 + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                        l_Registros=l_Registros + "<label style='cursor:pointer;font-size:12px;' >" +   l_Estatus + "</label>";
                        l_Registros=l_Registros + "</div>";   

                        if(l_Estatus=="NO RECIBIDO"){ 
                            l_Registros=l_Registros + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' >";
                            l_Registros=l_Registros + "<label id='lb_Etiqueta' style='font-size:12px; color:#2271b3; cursor:pointer;font-family:Arial black, Gadget, sans-serif;' onclick=\"fn_Imprimir_Etiqueta_Clic('" + l_nID +  "')\"> Imprimir " + " </label>";
                            l_Registros=l_Registros + "</div>";    
                        } else {
