           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   for(i=0;i<contador;i++){     
                       ...
                       l_Archivo=obResultado[i]["Archivo"];
                       ...
                       l_Linea=l_Linea  + "<label style='inline-flex' >";                                              
                       l_Linea=l_Linea  + "<a class='nav-link' style='font-family:Arial; margin-left:-15px'> " +  l_Archivo + "</a>";
                       l_Linea=l_Linea  + "</label>";
                       l_Linea=l_Linea + "</div>"; 
                       ...
                       l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i][l_Llave] +"&accion=Finalizar' style='color: #53BEFE;cursor:pointer; margin-right: -20px; font-family:Arial black, Gadget, sans-serif; '> Finalizar </a>"
