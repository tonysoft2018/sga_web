...
function fn_Ver_Detalles(l_nIDIxA_Deta, l_nIDIxA, l_nIDProducto, l_Codigo, l_Producto, l_UnidadDeMedida, l_Estado, l_Existencia, l_Conteo, l_Diferencia, l_Estado){
    ...
    l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 40px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
    l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
    l_Linea=l_Linea +  "Conteo";     
    l_Linea=l_Linea + "</label>";
    l_Linea=l_Linea + "</div>";

    l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 40px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
    l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
    l_Linea=l_Linea +  "Existencia";     
    l_Linea=l_Linea + "</label>";
    l_Linea=l_Linea + "</div>";

    l_Linea=l_Linea + "<div class='col-md-1  w-3 align-bottom align-self-center' style='height: 40px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
    l_Linea=l_Linea + "<label id='campo_" + 0 + "'>";
    l_Linea=l_Linea +  "Diferencia";     
    l_Linea=l_Linea + "</label>";
    l_Linea=l_Linea + "</div>";
    ...
    for(i=0;i<listadodeproductos.length;i++){
        ...
        l_Linea=l_Linea + "<label>" +  listadodeproductos[i]["estado"] + "</label>";
        l_Linea=l_Linea + "</div>"; 

        l_Linea=l_Linea + "<div class='col-md-1 justify-content-end align-items-right w-3 d-inline-block  text-break'  style='text-align:right'>";
        l_Linea=l_Linea + "<label>" +  listadodeproductos[i]["conteo"] + "</label>";
        l_Linea=l_Linea + "</div>"; 

        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' style='text-align:right' >";
        l_Linea=l_Linea + "<label>" +  listadodeproductos[i]["existencia"] + "</label>";
        l_Linea=l_Linea + "</div>"; 

        l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block  text-break' style='text-align:right'>";
        l_Linea=l_Linea + "<label>" +  listadodeproductos[i]["diferencia"] + "</label>";
        l_Linea=l_Linea + "</div>"; 
