           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                  ...
                  for(i=0;i<contador;i++){     
                      ...
                      l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block text-break align-middle' >";
                      l_Linea=l_Linea  + "<label style='inline-flex' >";                                              
                      l_Linea=l_Linea  + "<a class='nav-link' style='font-family:Arial; margin-left:-15px'> " + l_Rack + "</a>";
                      l_Linea=l_Linea  + "</label>";
                      l_Linea=l_Linea + "</div>"; 
                      ...
                      if(l_Estatus=="PROCESO"){
                        l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i][l_Llave] +"&accion=Ajustar' style='color: #53BEFE;cursor:pointer; margin-right: -20px; font-family:Arial black, Gadget, sans-serif; '> Ajustar </a>"
                        l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i][l_Llave] +"&accion=Cancelar' style='color: #53BEFE;cursor:pointer; margin-right: -20px; font-family:Arial black, Gadget, sans-serif; '> Cancelar </a>"
                       }
                      l_Linea=l_Linea  + "</label>";
                      l_Linea=l_Linea + "</div>";  
                ...
                l_Linea=l_Linea + "<tr>";
                 ...
                 l_Linea=l_Linea + "<tr>";
                 l_Linea=l_Linea + "<th scope='col' colspan=7 style='background-color:#F4F5F5;font-size:10px; font-family:Arial Black'> ";
