        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               for(i=0;i<contador;i++){     
                   l_Registros="";
                   l_Linea=l_Linea + "<div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;font-size:12px;'>";
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                     ...
                     l_Registros=l_Registros + "<div class='col d-flex justify-content-start align-items-left text-break' style='text-align:center; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                     ...
                     l_Registros=l_Registros + "<div class='col-md d-flex justify-content-start align-items-left text-break' style='text-align:left; font-size:10px; vertical-aling:middle;display:block; cursor:pointer;'>";
