    ...
    if(datos.length>0){
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               l_Linea=l_Linea + "<div class='row align-item-end h-25 align-items-center'  style='border-bottom: #D9DADA 2px solid;cursor:pointer;'>";
               ...
               l_Linea=l_Linea + "<div class='col-md-2  w-3 align-bottom align-self-center' style='height: 50px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>";
               l_Linea=l_Linea + " <label style='cursor:pointer;' > Capturados </label>";
               l_Linea=l_Linea + "</div>";
    
               l_Linea=l_Linea + "<div class='col-md-2  w-3 align-bottom align-self-center' style='height: 50px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;'>";
               ...
               for(i=0;i<contador;i++){     
                   ...
                   if(obResultado[i]["retorno"]=="TRUE"){ 
                        ...
                        if(l_Estatus=="RECIBO"){
                            ...
                            l_Registros=l_Registros + "<div id='id_r" + i +"' class='row align-item-end h-20 justify-content-middle'  style='background-color:#00FF00; border-bottom: #D9DADA 2px solid;cursor:pointer;font-size:12px;margin-top:-20px;'>";
                            ...
                            l_Registros=l_Registros + "<div id='id_r" + i +"' class='row align-item-end h-20 align-items-start ' style='border-bottom: #D9DADA 2px solid;cursor:pointer;font-size:12px;'>";
