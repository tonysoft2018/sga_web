           ...
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   for(i=0;i<contador;i++){   
                          ...
                          l_Linea=l_Linea + "<div class='col-md-1 justify-content-start align-items-left w-3 d-inline-block text-break align-middle' >";
                          l_Linea=l_Linea  + "<label style='inline-flex' >";                                              
                          l_Linea=l_Linea  + "<a class='nav-link' style='font-family:Arial; margin-left:-15px'> " +  l_Tipo + "</a>";
                          l_Linea=l_Linea  + "</label>";
                          l_Linea=l_Linea + "</div>"; 
                          ...
                          if(l_Estatus=="ABIERTO" && l_Tipo=="RECEPCION"){                
                            ...
                            l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i][l_Llave] +"&accion=Imprimir' style='color: #53BEFE;cursor:pointer; margin-right: -20px;  font-family:Arial black, Gadget, sans-serif; '> Imprimir </a>"
                          }

                          if(l_Estatus=="CERRADO" && l_Tipo=="ENVIO"){
                            l_Linea=l_Linea  + "<a class='nav-link' href='" + MODULO + "_editar.php?id=" + obResultado[i][l_Llave] +"&accion=Crear' style='color: #53BEFE;cursor:pointer; margin-right: -20px;  font-family:Arial black, Gadget, sans-serif; '> Recibir </a>"
                          }
...
function fn_Ver_ListadoDeProductos_Estatus_Consulta(){
    ...
    for(i=0;i<listadodeproductos.length;i++){
        if(listadodeproductos[i]["estatus"]=="LEIDO"){
           ...
           l_Linea=l_Linea + "<div id='id_r" + i +"' class='row align-item-end h-20 align-items-start ' style='border-bottom: #D9DADA 2px solid;font-size:12px;background-color:#2ECC71'>";
