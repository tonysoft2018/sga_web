        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(obResultado[0]["retorno"]=="TRUE"){ 
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Usuario')\">";
                   l_Linea=l_Linea + "Usuario";
                   ...
                   l_Linea=l_Linea + "<label id='campo_" + i + "'  onclick=\"fn_Listado_Ordenar_Clic('Perfil')\">";
                   l_Linea=l_Linea + "Perfil"
                   l_Linea=l_Linea + "<img src='../iconos/updown.png' style='width: 10px; height: 10px; margin-left:2px;'>";
                   l_Linea=l_Linea + "</label>";
                   l_Linea=l_Linea + "</div>";
                   ...
                   for(i=0;i<contador;i++){     
                       ...
                       l_Usuario=obResultado[i]["Usuario"];
                       l_Nombre=obResultado[i]["Nombre"];
                       l_Perfil=obResultado[i]["Perfil"];
                       ...
                       l_Linea=l_Linea  + "<a class='nav-link' style='font-family:Arial; margin-left:-15px'> " +  l_Usuario + "</a>";
                       l_Linea=l_Linea  + "</label>";
                       l_Linea=l_Linea + "</div>"; 
                       ...
                       l_Linea=l_Linea + "<div class='col-md-3 justify-content-start align-items-left w-3 d-inline-block text-break align-middle' >";
                       l_Linea=l_Linea  + "<label style='inline-flex' >";                                              
                       l_Linea=l_Linea  + "<a class='nav-link' style='font-family:Arial; margin-left:-15px'> " +  l_Perfil + "</a>";
                       l_Linea=l_Linea  + "</label>";
                       l_Linea=l_Linea + "</div>"; 
        ...
        xmlhttp.onreadystatechange = function() {
           if (this.readyState == 4 && this.status == 200) {
               ...
               if(l_Usuario=="Admin"){
                ...
                document.getElementById("cb_nIDPerfil").disabled=true;  
               }
           }        
        };
