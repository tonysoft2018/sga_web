            ...
            switch($l_Modulo){
             ...
             // RECIBO
                ...
                case "ubicaciones":
                 ...
                 case "inspeccion":
        ?>
                        <a class="nav-link" style='margin-left:-30px;'><button id='bt_Recibo' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Finalizar_Inspeccion_Clic()">Finalizar</button></a>                                                                                      
