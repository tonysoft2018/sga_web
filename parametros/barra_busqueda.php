          ...
          <div class="col-12 align-middle d-flex align-items-center .hidden-md float-xs-right" style='vertical-aling:middle;display:block;font-size:10px; font-family:"Arial Black", Gadget, sans-serif'>
            <table style='width:100%;text-align:rigth;margin-left:-10px;'>          
              <tr>
                <td>
                  <form id='frm_Consultar' class="form-inline borderless" style='border-style: none;'> 
                    <input id='Consulta' name='Consulta' type="text" placeholder="Buscar por Folio" class="form-control" style='height: 30px; font-size:10px; font-family:"Arial Black", Gadget, sans-serif;  '>
                    <a class="nav-link" href="#" >
                      <button type="button" class="btn btn-primary" style='margin-left:-15px;font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Listado_Clic('')">Buscar</button>
                    </a>                         
                  </form>
          ...
          <div class="col-12 align-middle d-flex align-items-center .hidden-md float-xs-right" style='vertical-aling:middle;display:block;font-size:10px; font-family:"Arial Black", Gadget, sans-serif'>
            <table style='width:100%;text-align:rigth;margin-left:-10px;'>          
              <tr>
                <td>
                  <form id='frm_Consultar' class="form-inline borderless" style='border-style: none;'> 
                    <input id='Consulta' name='Consulta' type="text" placeholder="Folio" class="form-control" style='height: 30px; font-size:10px; font-family:"Arial Black", Gadget, sans-serif;  '>
                    <a class="nav-link" href="#" >
                      <button type="button" class="btn btn-primary" style='margin-left:-15px;font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Listado_Clic('')">Buscar</button>
                    </a>                         
                  </form>
          ...
          <div class="col-12 align-middle d-flex align-items-center .hidden-md float-xs-right" style='vertical-aling:middle;display:block;font-size:10px; font-family:"Arial Black", Gadget, sans-serif'>
            <table style='width:100%;text-align:rigth;margin-left:-10px;'>          
              <tr>
                <td>
                  <form id='frm_Consultar' class="form-inline borderless" style='border-style: none;'> 
                    <input id='Consulta' name='Consulta' type="text" placeholder="Folio Traspaso/Orden de Surtido" class="form-control" style='height: 30px; font-size:10px; font-family:"Arial Black", Gadget, sans-serif;  '>
                    <a class="nav-link" href="#" >
                      <button type="button" class="btn btn-primary" style='margin-left:-15px;font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Listado_Clic('')">Buscar</button>
                    </a>                         
                  </form>
...
?>  
      <!-- BUSQUEDA -->
      <div class="col-12"  style='vertical-aling:middle;display:block;font-size:14px; font-family:"Arial", Gadget, sans-serif;margin-left:-10px;'>                     
