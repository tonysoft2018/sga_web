		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                     <?php 
                        if($l_Accion!="Eliminar" && $l_Accion!="Ver" && $l_Accion!="Detalles" ){
                     ?>                       
                            <select name="nIDCat_ConceptoEntrada" id="cb_nIDCat_ConceptoEntrada" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="ConceptoEntrada" id="txt_ConceptoEntrada" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                ...
                <?php 
                        if($l_Accion=="Eliminar" || $l_Accion=="Ver"){
                     ?>        
                        <textarea class="form-control" rows="5" name="Comentarios" id="txt_Comentarios" style='height: 100px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >  </textarea>        
                <?php        
                        } else {
                ?>
                        <textarea class="form-control" rows="5" name="Comentarios" id="txt_Comentarios" style='height: 100px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' >  </textarea>        
                <?php            
                        }
                 ?>
...
?>           
 ...
 <script>
 function fn_Recibo(){
    var l_nID=<?php echo $l_nID ?>

    fn_Recibo_Clic(l_nID);
 }
 </script>
