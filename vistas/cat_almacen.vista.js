...
function fn_Cat_Almacen_PorCentroDeServicio_Clic(){   
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( {"consulta":"", "condicion":l_Consulta, "tipo":"directa", "campos":"todos","campodeordenamiento": "", "formadeordenamiento":FORMA_ORDENAMIENTO,"cantidadregistros":NUMERODEREGISTROS } );     
...
function fn_Cat_Almacen_Inspeccion_Clic(l_Consulta,l_Seleccion,l_Accion){     
    ...
    // Procesar
    var arreglo=new Array();
    arreglo.push( { "condicion":l_Consulta, "seleccion":l_Seleccion, "tipo":"directa", "campos":"todos","campodeordenamiento": "", "formadeordenamiento":FORMA_ORDENAMIENTO,"cantidadregistros":NUMERODEREGISTROS, "modulo":MODULO, "accion":l_Accion } );
