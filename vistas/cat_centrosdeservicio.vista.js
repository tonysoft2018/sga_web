...
function fn_Actualizar_Clic(){
    ...
    if(DATOS.length>0){        
        // Enviar para procesdar
        var resultado=Actualizar(DATOS); 
...
function fn_Listado_Cargar_Clic(){
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        var resultado=Listado_Cargar(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
...
function fn_Listado_Grabar_Clic(){
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        var resultado=Listado_Grabar(arreglo); 
    } else {
...
function fn_Cat_CentrosDeServicio_Clic(l_Consulta,l_Seleccion,l_Accion){     
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        var resultado=Cat_CentrosDeServicio_Combo(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_Consultar_Clic(l_Consulta){     
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        var resultado=Consultar(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
