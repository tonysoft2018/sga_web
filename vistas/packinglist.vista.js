...
function fn_Presentar_Adjunto_Archivo(){
    ...
    if(datos.length>0){
         ...
         if (this.readyState == 4 && this.status == 200) {
             ...
             l_Linea=l_Linea + "<div class='col-md d-flex justify-content-left align-items-center' style='height:55px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>";
             ...
             for(i=0;i<contador;i++){    
                 ...
                 if(obResultado[i]["retorno"]=="TRUE"){ 
                    ...
                    Carton=obResultado[i]["carton"];
                    Codigo=obResultado[i]["codigo"];
                    Descripcion=obResultado[i]["descripcion"];
                    CantidadTotal=obResultado[i]["cantidadpc"];
                    CantidadCajas=obResultado[i]["cantidadcaja"];
                    Cajas=obResultado[i]["cajas"];
                    PesoBruto=obResultado[i]["pesobruto"];
                    PesoNeto=obResultado[i]["pesoneto"];
                    TotalM3=obResultado[i]["totalm3"];
                    Estatus=obResultado[i]["estatus"];

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-start align-items-left' style='text-align:left; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   Carton + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-start align-items-left' style='text-align:left; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   Codigo + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-start align-items-left text-break' style='text-align:left; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   Descripcion + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   CantidadTotal + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   CantidadCajas + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   Cajas + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +  PesoBruto + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   PesoNeto + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-end align-items-right' style='text-align:right; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   TotalM3 + "</label>";
                    l_Registros=l_Registros + "</div>";    

                    l_Registros=l_Registros + "<div class='col-md d-flex justify-content-start align-items-left' style='text-align:left; font-size:12px; vertical-aling:middle;display:block; cursor:pointer;'>";  
                    l_Registros=l_Registros + "<label style='cursor:pointer;' >" +   Estatus + "</label>";
                    l_Registros=l_Registros + "</div>";                       
