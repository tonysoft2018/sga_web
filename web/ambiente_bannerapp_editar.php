...
<head>    
    ...
    <script type="text/javascript" src="../js/ambiente_bannerapp_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/ambiente_bannerapp.vista.js"></script>
    <script type="text/javascript" src="../utilerias/utilerias.js"></script>
     ...
     // ----------------------------------------------
       ...
       $tbl = new  cltbl_Ambiente_BannerApp_v2_0_0();
       $tbl->Inicializacion();
