...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // ambiente_datosdelaempresa_editar.php
        // ----------------------------------------------------------------------------------
        ...
        $l_Modulo="ambiente_datosdelaempresa"; 
...
<head>    
    ...
    <script type="text/javascript" src="../js/ambiente_datosdelaempresa_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/ambiente_datosdelaempresa.vista.js"></script>
	...
	<script>
     ...
     <?php
       ...
       include_once "../clases/ambiente_datosdelaempresa.mysql.class_v2.0.0.php"; 
       ...
       $tbl = new  cltbl_Ambiente_DatosDeLaEmpresa_v2_0_0();
       $tbl->Inicializacion();
     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                         
                 <input type="text" name="ID" id="txt_ID" class="form-control" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                  
            </div>

            <div class="d-xs-block col-md-2">	
                <label  name="oIDCliente" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;display:block' >(*) </label> 
            </div>
         </div>

         <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-2">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Razon Social</label> 
            </div>
            <div class="col-md-8">	  	                        
                 <input type="text" name="RazonSocial" id="txt_RazonSocial" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                 
            </div>
            <div class="d-xs-block col-md-2">	
                <label  name="oIDCliente" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;display:block' >(*) </label> 
            </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                        
                 <input type="text" name="Calle" id="txt_Calle" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                  
            </div>
            <div class="d-none d-sm-block col-md-1">	  
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                    
                 <input type="text" name="Colonia" id="txt_Colonia" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                           
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	    	                        
                 <input type="text" name="Ciudad" id="txt_Ciudad" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                            
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	    	                        
                 <input type="text" name="Municipio" id="txt_Municipio" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                          
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                            
                 <input type="text" name="Estado" id="txt_Estado" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                           
            </div>
         </div>

         <div class="row" style='margin-bottom:2px;'>
            <div class="col-2">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Pais</label> 
            </div>
            <div class="col-md-8">	                          
                 <input type="text" name="Pais" id="txt_Pais" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                          
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            <div class="col-2">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Telefono1</label> 
            </div>
            <div class="col-md-8">	    	                        
                 <input type="text" name="Telefono1" id="txt_Telefono1" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                            
            </div>
         </div>

         <div class="row" style='margin-bottom:2px;'>
            <div class="col-2">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Telefono2</label> 
            </div>
            <div class="col-md-8">	     	                        
                 <input type="text" name="Telefono2" id="txt_Telefono2" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                            
            </div>
         </div>

         <div class="row" style='margin-bottom:2px;'>
            <div class="col-2">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Telefono3</label> 
            </div>
            <div class="col-md-8">	                        
                 <input type="text" name="Telefono3" id="txt_Telefono3" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                         
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                            
                 <input type="text" name="Celular1" id="txt_Celular1" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                           
                 <input type="text" name="Celular2" id="txt_Celular2" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                            
                 <input type="text" name="Celular3" id="txt_Celular3" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                           
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                        
                 <input type="text" name="Email1" id="txt_Email1" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                            
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	  	                        
                 <input type="text" name="Email2" id="txt_Email2" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                           
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                          
                 <input type="text" name="Email3" id="txt_Email3" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                         
            </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-8">	                         
                 <input type="text" name="Contacto" id="txt_Contacto" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >                           
            </div>
            <div class="d-xs-block col-md-2">		  
                <label  name="oIDCliente" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;display:block' >(*) </label> 
            </div>
