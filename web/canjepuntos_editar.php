...
<head>    
    ...
    <script type="text/javascript" src="../js/canjepuntos_deta.rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/canjepuntos_deta.vista.js"></script>

    <script type="text/javascript" src="../js/canjepuntos_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/canjepuntos.vista.js"></script>
...
<!-- FIN MENSAJES -->           
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                 <div class="col-md-3">	                         
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Cliente </label> 
                 </div>
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion=="Crear"){
                     ?>
                            <select name="nIDCat_Cliente" id="cb_nIDCat_Cliente" class="form-control-select border border-primary" style='max-width:350px; height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >
                                <option value="0" selected >Ninguno</option>                                                                               
                            </select>
                            <?php
                        }  else {
                     ?>
                            <input type="text" name="RazonSocial" id="txt_RazonSocial" class="form-control border border-primary" style='max-width:350px; height: 30px;width:100%;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_Cliente" id="txt_IDCat_Cliente" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                 ...
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion=="Crear"){
                     ?>
                            <select name="nIDCat_CentroDeServicio" id="cb_nIDCat_CentroDeServicio" class="form-control-select border border-primary" style='max-width:350px; height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onchange="fn_Cat_Almacen_PorCentroDeServicio_Clic();">
                                <option value="0" selected >Ninguno</option>                                                                               
                            </select>
                     <?php
                        }  else {
                     ?>
                            <input type="text" name="CentroDeServicio" id="txt_CentroDeServicio" class="form-control border border-primary" style='max-width:350px; height: 30px;width:100%;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_CentroDeServicio" id="txt_IDCat_CentroDeServicio" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                 ...
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion=="Crear"){
                     ?>
                            <select name="nIDCat_Almacen" id="cb_nIDCat_Almacen" class="form-control-select border border-primary" style='max-width:350px; height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>
                                <option value="0" selected >Ninguno</option>                                                                               
                            </select>
                     <?php
                        }  else {
                     ?>
                            <input type="text" name="Almacen" id="txt_Almacen" class="form-control border border-primary" style='max-width:350px; height: 30px;width:100%;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
 ...
 <div class="container" >
    <div id='contenido'> 
        <div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;width:105%'>
 ...
 <div class="container" >
    <div id='contenido'> 
        <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2">	               
                     <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Codigo iZeta</label> 
                 </div>
                 <div class="col-md-4">	                 
                     <input type="text" name="Etiqueta" id="txt_Etiqueta" class="form-control border border-primary" placeholder="Codigo de Barras" style='height: 30px;width:100%;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="fn_Buscar_Codigo_Clic(event)" >
                 </div>
                 <div class="col-md-2">	               
                 <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Descripcion </label> 
                 </div>
                 <div class="col-md-4">	                 
                 <textarea class="form-control border border-primary" rows="5" name="Descripcion" id="txt_Descripcion" style='height: 50px;width:100%;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px;resize:none ' readonly >  </textarea>
                 </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                ...
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Cantidad </label> 
                 ...
                 <div class="col-md-4">	 
                     <input type="text" name="Puntos" id="txt_Puntos" class="form-control border border-primary" placeholder="0" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px;text-align:right; ' readonly >                                  
                 </div>
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                 ...
                 <div class="col-md-4">	 
                 <a class="nav-link" style='margin-left:-30px;'><button id='bt_Anexar' type="button" class="btn btn-primary" style='width:100%;font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Anexar_Codigo_CLick()">Agregar</button></a>  
                 </div>
         </div>      
    </div>    
 </div>    
 ...
 <script>
        ...
        <?php 
            if($l_Accion=="Crear"){
        ?>
                    fn_Cat_Clientes_Clic('',0,ACCION);  
                    fn_Cat_CentrosDeServicio_Clic('',0,ACCION);                                     
        <?php
            }  else {
        ?>
                fn_Consultar_Clic("nIDCanje=" + NID);      
                fn_Consultar_Detalles_Clic("nIDCanje=" + NID);  
        <?php
            }
        ?>    
