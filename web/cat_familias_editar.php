     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">                       
                 <input type="text" name="IDFamilia" id="txt_IDFamilia" class="form-control" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar" || $l_Accion=="Editar"){?>  readonly <?php } ?> >                  
            </div>             
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            <div class="col-3">	                                         
                <?php if($l_Accion!="Eliminar"){ ?>
                    <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Familia(*)</label> 
                <?php } else {  ?>
                    <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Familia</label> 
                <?php } ?>
            </div>
            <div class="col-md-9">                          
                 <input type="text" name="Familia" id="txt_Familia" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >
            </div>           
         </div>
