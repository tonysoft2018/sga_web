...
<head>    
    ...
    <script type="text/javascript" src="../js/cat_pasillos_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/cat_pasillos.vista.js"></script>

    <script type="text/javascript" src="../js/cat_racks_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/cat_racks.vista.js"></script>

    <script type="text/javascript" src="../js/cat_matriz_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/cat_matriz.vista.js"></script>
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <input type="hidden" name="nIDUsuario" id="txt_nIDUsuario" class="form-control" value='1' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>            
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">	       	                        
                 <input type="text" name="IDMatriz" id="txt_IDMatriz" class="form-control" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar" || $l_Accion=="Editar"){?>  readonly <?php } ?>>                                    
            </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-3">	                                         
                <?php if($l_Accion!="Eliminar"){ ?>
                    <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Matriz(*)</label> 
                <?php } else {  ?>
                    <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Matriz</label> 
                <?php } ?>      
            </div>
            <div class="col-md-9">	       	                            
                 <input type="text" name="Matriz" id="txt_Matriz" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>                                    
            </div>            
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                 ...
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion!="Eliminar"){
                     ?>
                            <select name="nIDCat_Almacen" id="cb_nIDCat_Almacen" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                    ...
                    ?>
                            ...
                            <input type="hidden" name="nIDCat_Almacen" id="txt_nIDCat_Almacen" class="form-control" style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >            
                    <?php
                        }
                     ?>                     
                 </div>                  
         ...
         <div class="row" style='margin-bottom:2px;'>
                 <div class="col-md-3">	                         
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Pasillo </label> 
                 </div>
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion!="Eliminar"){
                     ?>
                            <select name="nIDCat_Pasillo" id="cb_nIDCat_Pasillo" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                               
                            </select>
                     <?php
                        } else {
                    ?>
                            <input type="text" name="Pasillo" id="txt_Pasillo" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_Pasillo" id="txt_nIDCat_Pasillo" class="form-control" style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >            
                    <?php
                        }
                     ?>                     
                 </div>                  
         ...
         <div class="row" style='margin-bottom:2px;'>
                 <div class="col-md-3">	                         
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Rack </label> 
                 </div>
                 <div class="col-md-9">	       
                     <?php 
                        if($l_Accion!="Eliminar"){
                     ?>
                            <select name="nIDCat_Rack" id="cb_nIDCat_Rack" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                               
                            </select>
                     <?php
                        } else {
                    ?>
                            <input type="text" name="Rack" id="txt_Rack" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_Rack" id="txt_nIDCat_Rack" class="form-control" style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >            
                    <?php
                        }
                     ?>                     
                 </div>                
