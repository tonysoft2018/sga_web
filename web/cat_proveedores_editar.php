     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">    	                        
                 <input type="text" name="IDProveedor" id="txt_IDProveedor" class="form-control" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px;' <?php if($l_Accion=="Eliminar" || $l_Accion=="Editar"){?>  readonly <?php } ?> >
            </div>            
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">                            
                 <input type="text" name="IDProveedor_IZeta" id="txt_IDProveedor_IZeta" class="form-control" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px;' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> >
            </div>
         </div>
