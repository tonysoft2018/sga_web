...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // entradaporotrosconceptos_detalles.php
        // ----------------------------------------------------------------------------------
        ...
        $l_Modulo="entradaporotrosconceptos_detalles"; 
...
<div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Entradas de Almacen </label> 
                 </div>
                 <div class="col-md-8">	 
                        <input type="text" name="" id="txt_Entrada" placeholder="Busqueda por Folio" class="form-control" style='height: 30px;width:100%;max-width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="Buscar_Entrada(event)" >    
                        <a class="nav-link" href="#" style='margin-left:-30px;'>
                              <button id='bt_Buscar' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Buscar_Entrada_Clic()">Buscar</button>                               
                              <button id='bt_Cancelars' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;visibility:hidden;' onclick="fn_Cancelar_Entrada_Clic()">Cancelar</button>                               
                        </a>      
