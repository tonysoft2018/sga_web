...
<head>    
    ...
    <script type="text/javascript" src="../js/entradasxcompras_deta_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/entradasxcompras_deta.vista.js"></script>

    <script type="text/javascript" src="../js/entradasxcompras_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/entradasxcompras.vista.js"></script>
     ...
     <div class="container" >
        ...
        <div class="row align-item-end h-20 bg-dark">			 
            <div class="col-12 align-middle d-flex align-items-center .hidden-md float-xs-right" style='vertical-aling:middle;display:block;font-size:10px; font-family:"Arial Black", Gadget, sans-serif'>
                <label style='margin-top:10px; color:#fff;'>   PackingList. Codigo de Contenedores, Entrada de Productos  </label>
            </div>
        </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">	      
                <input type="text" name="Usuario_Nombre" id="txt_Usuario_Nombre" class="form-control border border-primary" style='max-width:350px; height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly>                                
            </div>            
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	     
                       <input type="text" name="Estatus" id="txt_Estatus" class="form-control border border-primary" style='height: 30px;width:150px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                
                 </div>                 
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-3">	               
                 ...
                 <div class="col-md-9">	                 
                    <input type="text" name="Proveedor" id="txt_Proveedor" class="form-control border border-primary " style='max-width:350px; height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	                     
                        <input type="text" name="Comprador" id="txt_Comprador" class="form-control border border-primary" style='max-width:350px; height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	   
                    <input type="text" name="Puerto" id="txt_Puerto" class="form-control border border-primary" style='max-width:350px; height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                                                     
                 </div>                  
         </div>
