...
<head>    
    ...
    <script type="text/javascript" src="../js/etiquetado_deta_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/etiquetado_deta.vista.js"></script> 
     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">	      
                <input type="text" name="Usuario_Nombre" id="txt_Usuario_Nombre" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly>                                
            </div>            
            <input type="hidden" name="nIDUsuario" id="txt_nIDUsuario" class="form-control  border border-primary" value='<?php echo $NIDUSUARIO ?>' style='height: 30px;width:400px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>   
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 ?>
                        <input type="text" name="Estatus" id="txt_Estatus" class="form-control  border border-primary" style='height: 30px;width:100px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                
                 <?php         
                      }
                 ?>                     
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	                   
                            <input type="text" name="Proveedor" id="txt_Proveedor" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	                  
                     <input type="text" name="Comprador" id="txt_Comprador" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <input type="hidden" name="nIDComprador" id="txt_ID_Comprador" class="form-control  border border-primary" style='height: 30px;width:400px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                    
                 </div>                 
         </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <?php
                      if($l_Accion=="Crear"){
                 ?>
                        <input type="text" name="Puerto" id="txt_Puerto" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >                
                 <?php         
                      } else {
                 ?>
                        <input type="text" name="Puerto" id="txt_Puerto" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                
                 <?php         
                      }
                 ?>                     
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <?php
                      if($l_Accion=="Crear"){
                 ?>
                        <input type="text" placeholder="aaaa-mm-dd" name="FechaImportacion" id="txt_Importacion"  class="form-control  border border-primary" style='height: 30px;width:95px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >                
                 <?php         
                      } else {
                 ?>
         ...
         <div class="row" style='margin-bottom:2px;'>
            ...
            <div class="col-md-9">	      
                <input type="text" name="Archivo" id="txt_Archivo" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >                                
            </div>            
            <input type="hidden" name="nIDUsuario" id="txt_nIDUsuario" class="form-control  border border-primary" value='<?php echo $NIDUSUARIO ?>' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>   
         </div>
