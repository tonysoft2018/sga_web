...
<html>
    <?php
        ...
        $l_Modulo="inventarioxarticulo_conteo"; 
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                     ...
                     ?>                       
                            <select name="nIDIxA" id="cb_nIDIxA" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	   
                      <input type="text" name="Etiqueta" id="txt_Etiqueta" placeholder="Captura de Codigo IZeta" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="fn_Buscar_Codigo_Enter(event)" > 
