...
<html>
    <?php
        ...
        $l_Modulo="inventarioxarticulo_lectura"; 
    ...
    <script type="text/javascript" src="../utilerias/utilerias.js"></script>
     ...
     <?php
      ...
      $l_FechaLocal = $UtileriasDatos->ConvertirFechaYHora($l_FechaLocal);
       ...
       $l_Folio=0;
       $l_Condicion="Codigo_IZeta='" . $l_Codigo . "' and nIDIxA=" . $l_nID;
       /*
 ...
 <!-- <form id='frm_Actualizar'> -->
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <input type="hidden" name="Codigo" id="txt_Codigo" class="form-control" value='<?php echo $l_Codigo ?>' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>    
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Estado de Producto </label> 
                 </div>
                 <div class="col-md-8">	 
                    <select name="nIDCat_Estado" id="cb_nIDCat_Estado" class="form-control-select" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	   
                     <input type="text" name="Etiqueta" id="txt_Etiqueta" placeholder="Captura de Etiqueta" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="fn_Buscar_Codigo_Lectura_Enter(event)" > 
                      <a class="nav-link" href="#" style='margin-left:-30px;'>
                              <button type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Buscar_Codigo_Lectura_Clic()">Buscar</button>
                      </a>                                
                 </div>
                 <div class="d-xs-block col-md-2">	
         ...
         <div class="row" style='margin-bottom:2px;'>
                ...
                <div class="col-md-8">    
                    <textarea class="form-control" rows="5" name="Descripcion" id="txt_Descripcion" style='height: 100px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px;resize: none; ' readonly  >  </textarea>
                </div>
         </div>
    ...
    <div id='contenido_productos'>        
         <div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;padding-bottom:10px;'>
              <div class='col d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
               ...
               <div class='col d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                   <label style='cursor:pointer;' > Estado del Producto </label>
               </div>
...
?>           
 ...
 <script>
    function fn_Buscar_Codigo_Enter(e){
        if (e.keyCode == 13) {
