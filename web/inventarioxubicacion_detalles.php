...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // inventarioxubicacion_detalles.php
        // ----------------------------------------------------------------------------------
        ...
        $l_Modulo="inventarioxubicacion_detalles"; 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2">	
                    <?php if($l_Accion=="Crear"){ ?>
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Inventario por Ubicacion (*)</label> 
                    <?php } else {  ?>
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Inventario por Ubicacion</label> 
                    <?php } ?>                         
                 </div>
                 <div class="col-md-9">	 
                     <?php 
                         if($l_Accion=="Crear"){
                     ?>                       
                            <select name="nIDIxU" id="cb_nIDIxU" class="form-control-select border border-primary" style='max-width:300px;height: 30px;width:100%;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
 ...
 <form id='frm_Detalles' style='visibility:hidden'>
  <div class="container" >
    <div id='contenido_productos'>    
      <div class='row align-item-end h-30 align-items-center ' style='height:40px; border-bottom: #D9DADA 2px solid;cursor:pointer;padding-bottom:10px;'>

             <div class='col-md-3 d-flex justify-content-left align-items-center w-3' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                <label style='cursor:pointer;' > Ubicacion</label>
            </div>
            ...
            <div class='col-md-1 d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                <label style='cursor:pointer;' > Estado</label>
            </div>                    

            <div class='col-md-1 d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                <label style='cursor:pointer;' > Conteo </label>
            </div>       
         </div>
    </div>
