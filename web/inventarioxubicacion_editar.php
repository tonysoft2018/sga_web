...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // inventarioxubicacion_editar.php
        // ----------------------------------------------------------------------------------
...
<head>    
    ...
    <script type="text/javascript" src="../js/inventarioxubicacion_deta_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/inventarioxubicacion_deta.vista.js"></script>

    <script type="text/javascript" src="../js/inventarioxubicacion_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/inventarioxubicacion.vista.js"></script>
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <input type="hidden" name="nIDIxU" id="txt_nIDIxU" class="form-control" value='<?php echo $l_nID ?>' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>                                   
                ...
                <div class="col-md-3">	
                 ...
                 <div class="col-md-9">	 
                     <?php 
                         if($l_Accion=="Crear"){
                     ?>                       
                            <select name="nIDCat_Almacen" id="cb_nIDCat_Almacen" class="form-control-select border border-primary" style='max-width:300px; height: 30px;width:100%;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="Almacen" id="txt_Almacen" class="form-control border border-primary" style='max-width:300px; height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	
                    <?php if($l_Accion=="Crear"){ ?>
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Rack(*)</label> 
                    <?php } else {  ?>
                 ...
                 <div class="col-md-9">	 
                     <?php 
                         if($l_Accion=="Crear"){
                     ?>                       
                            <select name="nIDCat_Rack" id="cb_nIDCat_Rack" class="form-control-select border border-primary" style='max-width:300px; height: 30px;width:100%;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="Rack" id="txt_Rack" class="form-control border border-primary" style='max-width:300px; height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_Rack" id="txt_IDCat_Rack" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <?php
                        }
                     ?>
                 </div>
  ...
  <!-- REGISTROS -->
  <?php if($l_Estatus=="ABIERTO" || $l_Estatus=="PROCESO" || $l_Estatus=="CERRADO" ){ ?>
