...
<head>
    ...
    <script>
          var CAMPO_ORDENAMIENTO="";
        var FORMA_ORDENAMIENTO="";
        var ULTIMA_CONSULTA="";
        var ULTIMA_CONDICION="";
        var NUMERODEREGISTROS="0";
        var PAGINA_ACTUAL="0";

        var UBICACION_CONTROL="";
        ...
        <!-- FIN ENCABEZADOS LISTADO -->
         ...
         <div class="row">
            ...
            <?php if(strlen($l_IMAGENFONDOAPP)>0){ ?>
                    <img src="<?php echo $l_UBICACION . $l_IMAGENFONDOAPP ?>" alt="" class="img-responsive center-block" style="opacity: 0.3;width: 480px;height: 190px;margin-top: -200px;margin-left: -290px;left: 50%;top: 10%;position: absolute;z-index:-20;" width="580" height="290" > 
                <?php } ?>
			 </div>
         </div>		 
         <!-- FIN REGISTROS -->  
     	...
     	<div class="modal-dialog">
     	    <div class="modal-content" style='background-color:#FF0000;'>
	            ...
	            <!-- CABEZERA -->
     	        ...
     	        <!-- CUERPO -->
     	        <div class="modal-body justify-content-center align-items-center " style='color:#fff;'>
     	     	   <center><label id='lbl_mensaje_falla'> NO DISPONIBLE PARA EL USUARIO ACTUAL </label></center>
     	        </div>
