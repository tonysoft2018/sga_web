...
<!-- FIN MENSAJES -->     
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">	
         ...
         <input type="hidden" name="nIDOrdenDeSurtido" id="txt_nIDOrdenDeSurtido" class="form-control" value='<?php echo $l_nID ?>' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>                                   
         ...
         <input type="hidden" name="nIDAutorizo" id="txt_nIDAutorizo" class="form-control" value='0' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>    
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Almacén Origen</label> 
                 </div>
                 <div class="col-md-9">	 
                     <?php 
                        if($l_Accion=="Crear" ){
                     ?>                       
                            <select name="nIDCat_Almacen_Origen" id="cb_nIDCat_Almacen_Origen" class="form-control-select border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; '>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Almacén Destino</label> 
                 </div>
                 <div class="col-md-9">	 
                     <?php 
                          if($l_Accion=="Crear" ){
                     ?>                       
                            <select name="nIDCat_Almacen_Destino" id="cb_nIDCat_Almacen_Destino" class="form-control-select border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
         ...
         <?php  if($l_Accion=="Crear" ){  ?>
            <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Código Producto</label> 
                 </div>
                 <div class="col-md-9">	 
                     <input id='txt_Codigo' name='Codigo' type="text" placeholder="" class="form-control border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif;margin-left:-10px; '>
                     <a class="nav-link" href="#" style='margin-left:-30px;'>
                               ...
                               <!-- <button type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Existencias_Clic()">Existencias</button> -->
                            </a>                         
                        </form>
                 </div>                 
            </div>
         ...
         ?>
            ...
            <div class="row" style='margin-bottom:2px;'>
                <div class="col-3">	                        
                       <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Creador</label> 
                </div>
                <div class="col-md-9">       
  ...
  <div class="container" >
    <div id='contenido_productos'>        
         <div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;padding-bottom:10px;'>
              <div class='col d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                    <label style='cursor:pointer;' > Código </label>
              </div>
 ...
 <script>
        ...
        ?>
                     fn_Cat_Almacen_Origen_Clic('',0,ACCION);  
                     fn_Cat_Almacen_Destino_Clic('',0,ACCION);                           
        <?php
            } 
        ?>        
 </script>	
