...
function fn_Listado_Clic(l_CondicionExtra){
    ...
    if(l_Consulta.length<=0){
        if(l_CondicionExtra.length>0){
            l_Consulta=l_CondicionExtra;
        }
    }  else {
        if(l_CondicionExtra.length>0){
            l_Consulta=l_Consulta + " and " + l_CondicionExtra;
        }
...
function fn_Listado_ConCondicion_Clic(l_Condicion){    
    var l_Consulta="";     
    var i=0;
 
    // Limpia la información
    l_Consulta=l_Condicion.trim();
    ...
    if(arreglo.length>0){       
        // Enviar para procesdar
        resultado=ListadoConCondicion(arreglo); 
    } else {
        console.log("ERROR NO SE CARGO LA INFORMACIÓN");
    }
}
...
function fn_PackingList_Clic(l_Consulta){     
    // Verificaciones
    if(l_Consulta.length<=0){
        console.log("ERROR NO TIENE CONSULTA");
        //return;
...
// ******************************************************************
// ARCHIVOS
function fn_Cargar_Adjunto_Archivo(){
