...
<!-- FIN MENSAJES -->         
     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row align-item-end h-20 align-items-center" style='border-bottom: #DDE0E1 2px solid;'>			 
            <?php include_once "../parametros/barra_botones_recepcion.php" ?>         
         </div>
         <!-- FIN BOTONES -->
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	               
                 ...
                 <div class="col-md-9">	   
                      <input type="text" name="Etiqueta" id="txt_Etiqueta" placeholder="Captura de Etiquetar" class="form-control  border border-primary" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="Validar_Codigo_Clic(event)" >                                       
                 </div>
 ...
 <script>
        ...
        fn_Consultar_Recibo_Clic("nIDPackingList=" + NIDPACKINGLIST);                 
