...
<head>    
    ...
    <script type="text/javascript" src="../js/reportes_inventario_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/reportes_inventario.vista.js"></script>
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-6">	   
                <select name="nIDCat_Almacen" id="cb_nIDCat_Almacen" class="form-control-select" style='height: 30px;width:100%;max-width;font-size:10px; font-family:Arial, Gadget, sans-serif; '>
         ...
         <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-6">	   
                <a class="nav-link" href="#" style='margin-left:10px;'><button id='bt_Grabarx' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;margin-left:-25px' onclick="fn_Cargar_Inventario()">Cargar Reporte</button></a>                          
            </div>                
         </div>
            ...
            <div id='contenido'> 
                <div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;'>
                    <div class="col d-flex justify-content-left align-items-center" style='text-align:center; font-size:10px; font-family:"Arial black", Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                        <label style='cursor:pointer;' >Inventario por Almacen </label>
                    </div>
                </div>        
            </div>    
        </div>    
        ...
        <div class="container" >
            <div id='contenido_productos'>        
                <div class='row align-item-end h-20 align-items-center' style='border-bottom: #D9DADA 2px solid;cursor:pointer;padding-bottom:10px;'>
                    ...
                    <div class='col d-flex justify-content-left align-items-center' style='text-align:center; font-size:10px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F5;'>
                        <label style='cursor:pointer;' > Existencia</label>
                    </div>    
                </div>
            </div>    
        </div>    
