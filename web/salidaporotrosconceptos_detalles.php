...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // salidaporotrosconceptos_detalles.php
        // ----------------------------------------------------------------------------------
        ...
        $l_Modulo="salidaporotrosconceptos_detalles"; 
...
<head>    
    ...
    <script type="text/javascript" src="../js/salidaporotrosconceptos_deta_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/salidaporotrosconceptos_deta.vista.js"></script>

    <script type="text/javascript" src="../js/salidaporotrosconceptos_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/salidaporotrosconceptos.vista.js"></script>
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Salidas de Almacen </label> 
                 </div>
                 <div class="col-md-6">	 
                        <input type="text" name="" id="txt_Salida" placeholder="Busqueda por Folio" class="form-control" style='height: 30px;width:100%; max-width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="Buscar_Salida(event)" >    
                        <a class="nav-link" href="#" style='margin-left:-30px;'>
                              <button id='bt_Buscar' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;' onclick="fn_Buscar_Salida_Clic()">Buscar</button>                               
                              <button id='bt_Cancelars' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;visibility:hidden;' onclick="fn_Cancelar_Salida_Clic()">Cancelar</button>                               
                        </a>   
                        <label id='lbl_Salida' style='font-size:12px; font-family:"Arial", Gadget, sans-serif;margin-left:-10px;' >  </label>                        
                 </div>
                 <div class="d-xs-block col-md-2">	
                     <input type="hidden" name="nIDSalidaPorOtrosConceptos" id="txt_nIDSalidaPorOtrosConceptos" class="form-control" value='<?php echo $l_nID ?>' style='height: 30px;width:500px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; '>                                
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	   
                      <input type="text" name="Etiqueta" id="txt_Etiqueta" placeholder="Captura de Etiqueta" class="form-control" style='height: 30px;width:100%;max-width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="fn_Anexar_Codigo_CLick(event)" > 
                      <a class="nav-link" href="#" style='margin-left:-30px;'>
        ...
        <div class="container" >
           <div id='contenido_productos'>      
            ...
            <div class='row align-item-end h-20 align-items-center'  style='border-bottom: #D9DADA 2px solid;cursor:pointer;'> 
                ...
                <div class='col-md-5 w-3 align-bottom align-self-center' style='height: 40px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'>
                    <label id='campo_0'>
                        Descripción                     
                    </label>
                </div>

                <div class='col-md-3 w-3 align-bottom align-self-center' style='height: 40px;text-align:left; font-size:12px; font-family:Arial black, Gadget, sans-serif;vertical-aling:middle;display:block; cursor:pointer;background-color:#F4F5F6;margin-top: auto;margin-bottom: auto;'> 
                    <label id='campo_0'>
                        Unidad de Medida                
                    </label>
                </div>
