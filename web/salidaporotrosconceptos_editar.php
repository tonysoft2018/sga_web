...
<html>
    <?php
        ...
        $l_Modulo="salidaporotrosconceptos"; 
...
<head>    
    ...
    <script type="text/javascript" src="../js/cat_conceptossalida_rest.ctrl.js"></script>
    <script type="text/javascript" src="../vistas/cat_conceptossalida.vista.js"></script>
...
<!-- FIN MENSAJES -->           
     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	                                        
                        <?php if($l_Accion=="Crear"){ ?>
                            <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Conceptos de Salida(*)</label> 
                        <?php } else {  ?>
                            <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Conceptos de Salida</label> 
                        <?php } ?>
                 </div>
                 <div class="col-md-9">	 
                     <?php 
                        if($l_Accion=="Crear"){
                     ?>                       
                            <select name="nIDCat_ConceptoSalida" id="cb_nIDCat_ConceptoSalida" class="form-control-select border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="ConceptoSalida" id="txt_ConceptoSalida" class="form-control border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_ConceptoSalida" id="txt_nIDCat_ConceptoSalida" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <?php
                        }
                     ?>
                 </div>
 ...
 <script>
        ...
        ?>
                     ...
                     fn_Cat_ConceptosSalida_Clic('',0,ACCION);                
        <?php
            } 
        ?>        
 </script>	
