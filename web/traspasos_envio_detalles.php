                ...
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                        ...
                        <a class="nav-link" href="#" style='margin-left:-30px;'>
                              ...
                              <button id='bt_CancelarOrden' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;visibility:hidden;' onclick="fn_Cancelar_OrdenDeSurtido_Clic()">Cancelar</button>                               
                        </a>         
