     ...
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">	
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	                                      
                        <?php if($l_Accion=="Crear"){ ?>
                            <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Orden de Surtido(*)</label> 
                         <?php } else {  ?>
                 ...
                 <div class="col-md-9">	 
                     <?php 
                        if($l_Accion=="Crear"){
                     ?>                       
                            <select name="nIDOrdenDeSurtido" id="cb_nIDOrdenDeSurtido" class="form-control-select border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?> onchange="fn_CargarDatosOrden()">
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="OrdenDeSurtido_Folio" id="txt_OrdenDeSurtido_Folio" class="form-control border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="text" name="OrdenDeSurtido_Fecha" id="txt_OrdenDeSurtido_Fecha" class="form-control border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDOrdenDeSurtido" id="txt_nIDOrdenDeSurtido" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <?php
                        }
                     ?>
                 </div>                 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	                                        
                 ...
                 <div class="col-md-9">	 
                     <input type="text" name="Almacen_Origen" id="txt_Almacen_Origen" class="form-control border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <input type="hidden" name="nIDCat_Almacen_Origen" id="txt_IDCat_Almacen_Origen" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                 </div>                 
         </div>            

           <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-3">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Encargado de Entrega</label> 
            </div>
            <div class="col-md-9">	      
                <?php if($l_Accion=="Crear"){ ?>
                    <input type="text" name="Entrega" id="txt_Entrega" class="form-control border border-primary" value='' style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >     
                <?php } else {  ?>
                    <input type="text" name="Entrega" id="txt_Entrega" class="form-control" style='height: 30px;width:150px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly>     
                <?php } ?>                                        
            </div>            
         </div>                 
          ...
          <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-3">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Datos del Vehiculo</label> 
            </div>
            <div class="col-md-9">	      
                <?php if($l_Accion=="Crear"){ ?>
                    <input type="text" name="DatosDelVehiculo" id="txt_DatosDelVehiculo" class="form-control border border-primary" value='' style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >     
                <?php } else {  ?>
                    <input type="text" name="DatosDelVehiculo" id="txt_DatosDelVehiculo" class="form-control  border border-primary" style='height: 30px;width:150px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly>     
                <?php } ?>                                        
            </div>             
         </div>     
          ...
          <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	                                        
                 ...
                 <div class="col-md-9">	 
                 <input type="text" name="Almacen_Destino" id="txt_Almacen_Destino" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_Almacen_Destino" id="txt_IDCat_Almacen_Destino" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                 </div>                 
         </div>     

          <div class="row" style='margin-bottom:2px;'>
            <div class="col-md-3">	                        
                <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Encargado de Recibir</label> 
            </div>
            <div class="col-md-9">	      
                <?php if($l_Accion=="Crear"){ ?>
                    <input type="text" name="Recibe" id="txt_Recibe" class="form-control  border border-primary" value='' style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' >     
                <?php } else {  ?>
                    <input type="text" name="Recibe" id="txt_Recibe" class="form-control  border border-primary" style='height: 30px;width:150px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly>     
                <?php } ?>                                        
            </div>            
         </div>        
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-3">	                                        
                        <?php if($l_Accion=="Crear"){ ?>
                            <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;color:#FF0000;' >Motivo por Traspaso(*)</label> 
                         <?php } else {  ?>
                            <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' >Motivo por Traspaso</label> 
                        <?php } ?>
                 </div>
                 <div class="col-md-9">	 
                     <?php 
                        if($l_Accion=="Crear" ){
                     ?>                       
                            <select name="nIDCat_MotivosTraspaso" id="cb_nIDCat_MotivosTraspaso" class="form-control-select border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' <?php if($l_Accion=="Eliminar"){?>  readonly <?php } ?>>
                                <option value="0" selected >Ninguno</option>                                                                                    
                            </select>
                     <?php
                        } else {
                     ?>
                            <input type="text" name="Motivo" id="txt_Motivo" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                            <input type="hidden" name="nIDCat_MotivosTraspaso" id="txt_nIDCat_MotivosTraspaso" class="form-control" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                     <?php
                        }
                     ?>
                 </div>                 
         ...
         ?>
            <div class="row" style='margin-bottom:2px;'>
                ...
                <div class="col-md-9">       
                    <input type="text" name="Tipo" id="txt_Tipo" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                </div>
            </div>
            ...
            <div class="row" style='margin-bottom:2px;'>
                ...
                <div class="col-md-9">       
                <input type="text" name="Estatus" id="txt_Estatus" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
            ...
            <div class="row" style='margin-bottom:2px;'>
                ...
                <div class="col-md-9">       
                <input type="text" name="Nombre" id="txt_Nombre" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >

                </div>
            </div>
         <?php } ?> 

         <input type="hidden" name="Comentarios" id="txt_Comentarios" class="form-control  border border-primary" style='height: 30px;width:450px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >       
         <br>
         <br>
...
<?php if($l_Accion=="Cancelar" || $l_Accion=="Ver" || $l_Accion=="Detalles" ){ ?>
 <!-- REGISTROS -->
 ...
 <script>
        ...
        ?>                 
                     fn_Cat_MotivosTraspaso_Clic('',0,ACCION);     
                     fn_OrdenDeSurtido_Clic("Estatus='ORDEN SURTIDA - PENDIENTE EMBARCAR'",0,ACCION);                         
        <?php
            } 
        ?>        
 </script>	
 ...
 ?>
         <script>             
             ...
             fn_Consultar_Detalles_OrdenDeSurtido_Clic('nIDOrdenDeSurtido=<?php echo  $l_nIDOrdenDeSurtido ?>');
         </script>
 <?php
     } else {
 ?>
