...
<html>
    <?php
        // ----------------------------------------------------------------------------------
        // traspaso_recepcion_detalles.php
        // ----------------------------------------------------------------------------------
        ...
        $l_Modulo="traspasos_recepcion_detalles"; 
     	...
     	<div class="modal-dialog">
     	    <div class="modal-content" style='background-color:#009900;width:50%;'>
	            ...
	            <!-- CABEZERA -->
     	        <div class="modal-header">
     	     	    <h4 class="modal-title"></h4>
     	     	    <button type="button" class="close" data-dismiss="modal" onclick="Reiniciar_Clic()">&times;</button>
     	        </div>
     	        ...
     	        <!-- PIE DE PAGINA -->
     	        <div class="modal-footer">
     	     	    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="Reiniciar_Clic()">Cerrar</button>
     	        </div>
     	     </div>
         </div>     	 
        </center>
		...
		<div class="row align-item-end h-20 bg-dark">			 
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                        <label for="nombre" style='font-size:12px; font-family:"Arial black", Gadget, sans-serif;margin-left:-10px;' > Orden de Embarque </label> 
                 </div>
                 <div class="col-md-8">	 
                        <input type="text" name="" id="txt_OrdenDeSurtido" placeholder="Busqueda por Folio" class="form-control" style='height: 30px;width:100%; max-width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="Buscar_OrdenDeSurtido(event)" >    
                        <a class="nav-link" href="#" style='margin-left:-30px;'>
                              ...
                              <button id='bt_CancelarOrden' type="button" class="btn btn-primary" style='font-size:12px; font-family:"Arial", Gadget, sans-serif;visibility:hidden;' onclick="Reiniciar_Clic()">Cancelar</button>                               
                        </a>                          
                 </div>
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                        <input type="text" name="Almacen_Origen" id="txt_Almacen_Origen" value='' class="form-control" style='height: 30px;width:100%;max-witdh:350px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                        <input type="hidden" name="nIDCat_Almacen_Origen" id="txt_IDCat_Almacen_Origen" value='0' class="form-control" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                 </div>
                 <div class="d-xs-block col-md-2">	
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	 
                        <input type="text" name="Almacen_Destino" id="txt_Almacen_Destino" value='' class="form-control" style='height: 30px;width:100%;max-witdh:350px;font-size:10px; font-family:"Arial", Gadget, sans-serif; margin-left:-10px; ' readonly >
                        <input type="hidden" name="nIDCat_Almacen_Destino" id="txt_IDCat_Almacen_Destino" value='0' class="form-control" style='height: 30px;width:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' readonly >
                 </div>
                 <div class="d-xs-block col-md-2">	
         ...
         <div class="row" style='margin-bottom:2px;'>
                <div class="col-md-2 col-lg-2">	               
                 ...
                 <div class="col-md-8">	   
                      <input type="text" name="Etiqueta" id="txt_Etiqueta" placeholder="Captura de Etiqueta" class="form-control" style='height: 30px;width:100%;max-witdh:350px;font-size:10px; font-family:"Arial Black", Gadget, sans-serif; margin-left:-10px; ' onkeypress="fn_Anexar_Codigo_CLick(event)" > 
                      <a class="nav-link" href="#" style='margin-left:-30px;'>
