...
<!-- FIN MENSAJES -->      
 ...
 <form id='frm_Actualizar'>
     <div class="container" >
		...
		<div class="row align-item-end h-20 bg-dark">	
         ...
         <?php if($l_Accion=="Eliminar" || $l_Accion=="Ver" || $l_Accion=="Imprimir"|| $l_Accion=="Cancelar" || $l_Accion=="Detalles" ){ 
         ?>
            <div class="row" style='margin-bottom:2px;'>
                <div class="col-2">	                        
 ...
 <?php if($l_Accion=="Cancelar" || $l_Accion=="Ver" || $l_Accion=="Detalles" || $l_Accion=="Imprimir" ){ ?>
 <!-- REGISTROS -->
